import{j as e}from"./jsx-runtime-mA-n-d6H.js";import{r as i}from"./iframe-CBmONYCU.js";import"./preload-helper-ggYluGXI.js";const y=`:root,
[data-theme='light'] {
  /* color */
  /* brand primitives — Scan Teal ramp (other ramps resolve via fallbacks only) */
  --brand-100: #e6faf7;
  --brand-200: #c3f0e9;
  --brand-250: #9fe5db;
  --brand-300: #79d8cb;
  ...
  --color-background-brand-bold-default: var(--brand-700, #0f766e);
  --color-background-brand-bold-hovered: var(--brand-800, #115e58);
  --color-background-brand-bold-pressed: var(--brand-850, #134c47);
  --color-background-brand-boldest-default: var(--brand-1000, #16302d);
  --color-background-brand-boldest-hovered: var(--brand-900, #123c38);
  --color-background-brand-boldest-pressed: var(--brand-850, #134c47);
  --color-background-brand-subtlest-default: var(--brand-100, #e6faf7);
  --color-background-brand-subtlest-hovered: var(--brand-200, #c3f0e9);
  --color-background-brand-subtlest-pressed: var(--brand-250, #9fe5db);
  ...
  --color-background-selected-default: var(--brand-100, #e6faf7);
  --color-background-selected-hovered: var(--brand-200, #c3f0e9);
  --color-background-selected-pressed: var(--brand-300, #79d8cb);
  --color-background-selected-bold-default: var(--brand-700, #0f766e);
  --color-background-selected-bold-hovered: var(--brand-800, #115e58);
  --color-background-selected-bold-pressed: var(--brand-900, #123c38);
  ...
  --color-border-brand: var(--brand-700, #0f766e);
  ...
  --color-border-focused: var(--brand-500, #0d9488);
  ...
  --color-border-selected: var(--brand-700, #0f766e);
  ...
  --color-icon-brand: var(--brand-700, #0f766e);
  --color-icon-danger: var(--red-red700, #c9372c);
  --color-icon-default: var(--neutral-opaque-neutral1000, #212623);
  ...
  --color-icon-selected: var(--brand-700, #0f766e);
  ...
  --color-link-default: var(--brand-700, #0f766e);
  --color-link-pressed: var(--brand-800, #115e58);
  ...
  --color-text-brand: var(--brand-700, #0f766e);
  --color-text-danger: var(--red-red800, #ae2e24);
  --color-text-default: var(--neutral-opaque-neutral1000, #212623);
  ...
  --color-text-selected: var(--brand-700, #0f766e);
  ...
  --elevation-surface-sunken-default: var(--neutral-opaque-neutral100, #f4f7f6);
}
[data-theme='dark'] {
  /* color */
  ...
  --color-background-brand-bold-default: var(--brand-400, #45c7b6);
  --color-background-brand-bold-hovered: var(--brand-300, #79d8cb);
  --color-background-brand-bold-pressed: var(--brand-250, #9fe5db);
  --color-background-brand-boldest-default: var(--brand-100, #e6faf7);
  --color-background-brand-boldest-hovered: var(--brand-200, #c3f0e9);
  --color-background-brand-boldest-pressed: var(--brand-250, #9fe5db);
  --color-background-brand-subtlest-default: var(--brand-1000, #16302d);
  --color-background-brand-subtlest-hovered: var(--brand-900, #123c38);
  --color-background-brand-subtlest-pressed: var(--brand-850, #134c47);
  ...
  --color-background-selected-default: var(--brand-1000, #16302d);
  --color-background-selected-hovered: var(--brand-900, #123c38);
  --color-background-selected-pressed: var(--brand-800, #115e58);
  --color-background-selected-bold-default: var(--brand-400, #45c7b6);
  --color-background-selected-bold-hovered: var(--brand-300, #79d8cb);
  --color-background-selected-bold-pressed: var(--brand-200, #c3f0e9);
  ...
  --color-border-brand: var(--brand-400, #45c7b6);
  ...
  --color-border-focused: var(--brand-300, #79d8cb);
  ...
  --color-border-selected: var(--brand-400, #45c7b6);
  ...
  --color-icon-brand: var(--brand-400, #45c7b6);
  --color-icon-danger: var(--red-red500, #f15b50);
  --color-icon-default: var(--dark-neutral-opaque-dark-neutral1000, #ccd1cf);
  ...
  --color-icon-selected: var(--brand-400, #45c7b6);
  ...
  --color-link-default: var(--brand-400, #45c7b6);
  --color-link-pressed: var(--brand-300, #79d8cb);
  ...
  --color-text-brand: var(--brand-400, #45c7b6);
  --color-text-danger: var(--red-red300, #fd9891);
  --color-text-default: var(--dark-neutral-opaque-dark-neutral1000, #ccd1cf);
  ...
  --color-text-selected: var(--brand-400, #45c7b6);
  ...
  --elevation-surface-default: var(--dark-neutral-opaque-dark-neutral100, #1d2220);
  --elevation-surface-hovered: var(--dark-neutral-opaque-dark-neutral200, #222825);
  --elevation-surface-pressed: var(--dark-neutral-opaque-dark-neutral250, #292e2c);
  --elevation-surface-overlay-default: var(--dark-neutral-opaque-dark-neutral250, #292e2c);
  --elevation-surface-overlay-hovered: var(--dark-neutral-opaque-dark-neutral300, #2e3431);
  --elevation-surface-overlay-pressed: var(--dark-neutral-opaque-dark-neutral350, #3a403d);
  --elevation-surface-raised-default: var(--dark-neutral-opaque-dark-neutral200, #222825);
  --elevation-surface-raised-hovered: var(--dark-neutral-opaque-dark-neutral250, #292e2c);
  --elevation-surface-raised-pressed: var(--dark-neutral-opaque-dark-neutral300, #2e3431);
  --elevation-surface-sunken-default: var(--dark-neutral-opaque-dark-neutral0, #161918);
}
...
`,w=({name:o,variable:a,value:r})=>e.jsxs("div",{className:"color-box","data-color-value":r,children:[e.jsx("div",{className:"color-box__swatch",style:{backgroundColor:`var(${a}, ${r})`},"aria-label":`${o} color swatch`}),e.jsxs("div",{className:"color-box__info",children:[e.jsx("div",{className:"color-box__name",children:o}),e.jsx("div",{className:"color-box__variable",children:a}),e.jsx("div",{className:"color-box__value",children:r})]})]}),x=({title:o,colors:a})=>e.jsxs("div",{className:"color-group",children:[e.jsx("h3",{className:"color-group__title",children:o}),e.jsx("div",{className:"color-group__grid",children:a.map(r=>e.jsx(w,{name:r.name,variable:r.variable,value:r.value},r.variable))})]});function q(o){const a=[],r=/--color-([^:]+):\s*([^;]+);/g,l=new Set;let c=null;for(;(c=r.exec(o))!==null;){const n=`--color-${c[1].trim()}`,t=c[2].trim();if(!l.has(n)){l.add(n);let g=t;const f=t.match(/,\s*([^)]+)\)$/);f?g=f[1].trim():t.startsWith("var(")&&(g=t);const m=n.replace("--color-","").replace(/-/g," ").replace(/\b\w/g,k=>k.toUpperCase());a.push({name:m,variable:n,value:g})}}return a}function S(o){const a={};return o.forEach(r=>{const l=r.variable.match(/--color-([^-]+)/);if(!l)return;const c=l[1],n=c.charAt(0).toUpperCase()+c.slice(1).replace(/([A-Z])/g," $1");a[n]||(a[n]=[]),a[n].push(r)}),Object.entries(a).sort(([r],[l])=>{const c=["Background","Text","Border","Icon","Link","Chart","Interaction","Skeleton","Blanket"],n=c.indexOf(r),t=c.indexOf(l);return n!==-1&&t!==-1?n-t:n!==-1?-1:t!==-1?1:r.localeCompare(l)}).map(([r,l])=>({title:r,colors:l.sort((c,n)=>c.variable.localeCompare(n.variable))}))}const h=()=>{const[o,a]=i.useState([]);return i.useEffect(()=>{const r=q(y),l=S(r);a(l)},[]),e.jsxs("div",{className:"colors-container",children:[e.jsx("div",{style:{marginBottom:"2rem",padding:"1rem",background:"#f5f5f5",borderRadius:"8px"},children:e.jsxs("p",{style:{margin:0,fontSize:"0.875rem",color:"#666"},children:["Source:"," ",e.jsx("a",{href:"https://www.figma.com/design/RXclnIXmr2835BdXOKBJDL/ADS-Foundations--Community-?node-id=14439-10399&p=f&t=i4NwiBe0wp852FUm-0",target:"_blank",rel:"noopener noreferrer",style:{color:"#0066cc",textDecoration:"none"},children:"Jira Design System"})]})}),o.map(r=>e.jsx(x,{title:r.title,colors:r.colors},r.title))]})};h.__docgenInfo={description:"",methods:[],displayName:"Colors"};const R={title:"Design System/Colors",component:h,tags:["autodocs"],parameters:{docs:{description:{component:`
## Overview
...
- Ensure consistency across the application
        `}}}},C=[["100","#e6faf7"],["200","#c3f0e9"],["250","#9fe5db"],["300","#79d8cb"],["400","#45c7b6"],["500","#0d9488"],["600","#0f857c"],["700","#0f766e"],["800","#115e58"],["850","#134c47"],["900","#123c38"],["1000","#16302d"]],p=o=>{const a=r=>{const l=parseInt(o.slice(r,r+2),16)/255;return l<=.03928?l/12.92:((l+.055)/1.055)**2.4};return .2126*a(1)+.7152*a(3)+.0722*a(5)},z=(o,a)=>{const[r,l]=[p(o),p(a)].sort((c,n)=>n-c);return`${((r+.05)/(l+.05)).toFixed(2)}:1`},j=[["light","inverse text on brand bold","#ffffff","#0f766e","4.5:1"],["light","brand text on surface","#0f766e","#ffffff","4.5:1"],["light","focus ring on surface","#0d9488","#ffffff","3:1"],["dark","inverse text on brand bold","#1f1f21","#45c7b6","4.5:1"],["dark","brand text on surface","#45c7b6","#1d2220","4.5:1"],["dark","focus ring on surface","#79d8cb","#1d2220","3:1"]],v={fontFamily:"monospace",fontSize:13},d={padding:"8px 12px",borderBottom:"1px solid #e5e7eb",textAlign:"left"},b={parameters:{docs:{description:{story:"Scan Teal brand primitives (`--brand-100..1000`). Brand/selected/link/focus semantics map onto this ramp: light bold = 700, dark bold = 400. Information stays blue, visited links stay purple."}}},render:()=>e.jsx("div",{style:{display:"flex",maxWidth:720},children:C.map(([o,a])=>e.jsxs("div",{style:{flex:1,textAlign:"center"},children:[e.jsx("div",{style:{background:`var(--brand-${o}, ${a})`,height:56}}),e.jsx("div",{style:{...v,marginTop:4},children:o}),e.jsx("div",{style:{...v,color:"#6b7280"},children:a})]},o))})},s={parameters:{docs:{description:{story:"WCAG AA boundaries enforced by `colors.test.ts` in `@lodado/sdui-design-files`."}}},render:()=>e.jsxs("table",{style:{borderCollapse:"collapse",maxWidth:720},children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{style:d,children:"theme"}),e.jsx("th",{style:d,children:"pair"}),e.jsx("th",{style:d,children:"ratio"}),e.jsx("th",{style:d,children:"required"})]})}),e.jsx("tbody",{children:j.map(([o,a,r,l,c])=>e.jsxs("tr",{children:[e.jsx("td",{style:d,children:o}),e.jsx("td",{style:d,children:e.jsx("span",{style:{background:l,color:r,padding:"2px 8px",borderRadius:4},children:a})}),e.jsx("td",{style:{...d,...v},children:z(r,l)}),e.jsx("td",{style:{...d,...v},children:c})]},`${o}-${a}`))})]})};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
- Ensure consistency across the application
  ...
  parameters: {
    docs: {
      description: {
        story: 'Scan Teal brand primitives (\`--brand-100..1000\`). Brand/selected/link/focus semantics map onto this ramp: ' + 'light bold = 700, dark bold = 400. Information stays blue, visited links stay purple.'
      }
    }
  },
  render: () => <div style={{
    ...
    maxWidth: 720
      ...
      {BRAND_RAMP.map(([level, hex]) => <div key={level} style={{
      flex: 1,
      textAlign: 'center'
    }}>
          <div style={{
        background: \`var(--brand-\${level}, \${hex})\`,
        height: 56
      }} />
          <div style={{
        ...monoStyle,
  ...
  render: () => <table style={{
    ...
    maxWidth: 720
      ...
      <tbody>
        {CONTRAST_CHECKS.map(([theme, label, fg, bg, required]) => <tr key={\`\${theme}-\${label}\`}>
...
}`,...s.parameters?.docs?.source}}};const D=["Default","BrandRamp","ContrastMatrix"];export{b as BrandRamp,s as ContrastMatrix,u as Default,D as __namedExportsOrder,R as default};
