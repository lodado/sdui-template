import{j as n}from"./jsx-runtime-BbSBzeZ-.js";import"./marked.esm-DvVwiqbt.js";import{t as _}from"./toSduiLayout-EeX76f66.js";import{r as a}from"./iframe-BO7zmPaK.js";import{S as y}from"./SduiDocumentEditor-CP86qfkX.js";import{S as g}from"./SduiLayoutStateInspector-DrcGwXiJ.js";function E(e){return"blockId"in e?e.blockId:"block"in e?e.block.id:""}function L(e){const{type:t}=e,r=E(e);return r?`${t}  ${r}`:t}const T=({patches:e})=>e.length===0?n.jsx("pre",{className:"sdui-doc__log",children:"문서를 편집하면 여기에 패치가 순서대로 쌓입니다."}):n.jsx("pre",{className:"sdui-doc__log",children:e.slice(-10).map((t,r)=>`${String(e.length-Math.min(10,e.length)+r+1).padStart(2,"0")}  ${L(t)}`).join(`
