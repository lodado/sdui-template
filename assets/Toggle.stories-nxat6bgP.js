import{j as e}from"./jsx-runtime-Bn5U2jj6.js";import{r as u}from"./iframe-DStpXkDC.js";import{i as s,S as k,s as f}from"./sduiComponents-Dza7yqs-.js";import"./preload-helper-ggYluGXI.js";import"./index-Bj-pHb08.js";import"./index-DRxj8KRh.js";const j={title:"Shared/UI/Toggle",component:s,tags:["autodocs"],argTypes:{size:{control:"select",options:["regular","large"],description:"Toggle size variant",table:{defaultValue:{summary:"regular"}}},isChecked:{control:"boolean",description:"Whether the toggle is checked (controlled)",table:{defaultValue:{summary:"false"}}},isDisabled:{control:"boolean",description:"Whether the toggle is disabled",table:{defaultValue:{summary:"false"}}},isLoading:{control:"boolean",description:"Whether the toggle is in loading state",table:{defaultValue:{summary:"false"}}},label:{control:"text",description:"Accessible label for the toggle"}},parameters:{docs:{description:{component:`
## Overview
