import{j as n}from"./jsx-runtime-mA-n-d6H.js";import{d as E,s as r}from"./sduiComponents-Bh5wK3mF.js";import{S as d,u as L}from"./SduiLayoutRenderer-Dnhr9FUr.js";import{u as A}from"./useSduiNodeReference-_owUH_2d.js";import"./iframe-CBmONYCU.js";import"./preload-helper-ggYluGXI.js";import"./index-CDV7cqJ4.js";import"./index-CynUYlTt.js";import"./index-dCEBnlvI.js";import"./index-DP-BN3tX.js";import"./index-CcR-zJDu.js";import"./Button-DwzDj1Tt.js";import"./schemas-BKIZ752n.js";const k=({id:e})=>{const{attributes:o}=L({nodeId:e}),{referencedNodes:t,hasReference:i}=A({nodeId:e}),p=o?.className,T=o?.options;if(!i||t.length===0)return n.jsx("span",{className:p,children:"No reference"});const l=t[0]?.state?.selectedId,c=T?.find(B=>B.id===l)?.label||l||"None";return n.jsx("span",{className:p,children:c})};k.displayName="ReferenceText";const j=({id:e})=>{const{attributes:o}=L({nodeId:e}),{referencedNodes:t,hasReference:i}=A({nodeId:e}),p=o?.className,T=o?.optionsMap;return i?n.jsx("div",{className:p,children:t.map((a,l)=>{const c=a?.state?.selectedId,M=T?.[a.id]?.find(V=>V.id===c)?.label||c||"None";return n.jsxs("div",{children:[n.jsxs("span",{className:"text-gray-500",children:[a.id,":"]})," ",n.jsx("span",{className:"font-medium",children:M})]},a.id||l)})}):n.jsx("div",{className:p,children:"No references configured"})};j.displayName="ReferenceDisplay";const s={...r,ReferenceText:e=>n.jsx(k,{id:e}),ReferenceDisplay:e=>n.jsx(j,{id:e})},X={title:"Shared/UI/Dropdown",component:E.Root,tags:["autodocs"],parameters:{docs:{description:{component:`
## Overview
