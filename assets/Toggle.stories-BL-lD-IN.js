import{j as e}from"./jsx-runtime-kN5q7ta_.js";import{r as u}from"./iframe-5GmD24nK.js";import{i as s,s as k}from"./sduiComponents-D7qirgaL.js";import{S as f}from"./SduiLayoutRenderer-BIgj9fpk.js";import"./preload-helper-ggYluGXI.js";import"./index-BjY1jkyd.js";import"./index-DDZoHRzQ.js";import"./index-DMGz4e4h.js";import"./index-CPc4hXF3.js";import"./schemas-BKIZ752n.js";const w={title:"Shared/UI/Toggle",component:s,tags:["autodocs"],argTypes:{size:{control:"select",options:["regular","large"],description:"Toggle size variant",table:{defaultValue:{summary:"regular"}}},isChecked:{control:"boolean",description:"Whether the toggle is checked (controlled)",table:{defaultValue:{summary:"false"}}},isDisabled:{control:"boolean",description:"Whether the toggle is disabled",table:{defaultValue:{summary:"false"}}},isLoading:{control:"boolean",description:"Whether the toggle is in loading state",table:{defaultValue:{summary:"false"}}},label:{control:"text",description:"Accessible label for the toggle"}},parameters:{docs:{description:{component:`
## Overview
