...
}`,...G.parameters?.docs?.source},description:{story:"Interpolation Modes: 2D line chart with linear, cubic, and monotone cubic interpolation (canvas-3d 2D collection).",...G.parameters?.docs?.description}}};const Se=["StaticCube","RotatingCube","StaticHexagon","RotatingHexagon","StaticCup","RotatingCup","StaticCupFilled","RotatingCupFilled","InterpolationModes"];export{G as InterpolationModes,M as RotatingCube,Y as RotatingCup,B as RotatingCupFilled,O as RotatingHexagon,F as StaticCube,X as StaticCup,V as StaticCupFilled,H as StaticHexagon,Se as __namedExportsOrder,Re as default};
