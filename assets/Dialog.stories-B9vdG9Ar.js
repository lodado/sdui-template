import{j as e}from"./jsx-runtime-B1jkZvI5.js";import{c as a,S as o,s as i,d as x,D as n}from"./sduiComponents-DHkbB7Oh.js";import"./iframe-DBmxkCFe.js";import"./preload-helper-ggYluGXI.js";import"./index-wxXxgRnB.js";import"./index-Cox-AIaQ.js";const T={title:"Features/UI/Dialog",component:a,tags:["autodocs"],argTypes:{size:{control:"select",options:["small","medium","large","xlarge"],description:"Dialog size",table:{defaultValue:{summary:"small"}}},hasCloseButton:{control:"boolean",description:"Whether to show close button",table:{defaultValue:{summary:"true"}}},title:{control:"text",description:"Dialog title"},description:{control:"text",description:"Dialog description (optional)"}},parameters:{docs:{description:{component:`
## Overview
