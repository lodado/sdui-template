import{j as e}from"./jsx-runtime-9B6oo110.js";import{r as u}from"./iframe-DWXfGETz.js";import{i as s,s as k}from"./sduiComponents-B1M4w161.js";import{S as f}from"./SduiLayoutRenderer-DVnhpWid.js";import"./preload-helper-ggYluGXI.js";import"./index-Cz5FcQOX.js";import"./index-BlfGnNZs.js";import"./index-DhLu3UG5.js";import"./index-BsTZhkS3.js";import"./schemas-D-ljss90.js";const w={title:"Shared/UI/Toggle",component:s,tags:["autodocs"],argTypes:{size:{control:"select",options:["regular","large"],description:"Toggle size variant",table:{defaultValue:{summary:"regular"}}},isChecked:{control:"boolean",description:"Whether the toggle is checked (controlled)",table:{defaultValue:{summary:"false"}}},isDisabled:{control:"boolean",description:"Whether the toggle is disabled",table:{defaultValue:{summary:"false"}}},isLoading:{control:"boolean",description:"Whether the toggle is in loading state",table:{defaultValue:{summary:"false"}}},label:{control:"text",description:"Accessible label for the toggle"}},parameters:{docs:{description:{component:`
## Overview
