import{j as n}from"./jsx-runtime-BuoH1CR4.js";import{e as E,s as r}from"./sduiComponents-B2udai0d.js";import{S as d,u as L}from"./SduiLayoutRenderer-Dv0rmTt2.js";import{u as A}from"./useSduiNodeReference-CUAIjmlW.js";import"./iframe-CLJzqSCR.js";import"./preload-helper-ggYluGXI.js";import"./index-TwU6Tgq0.js";import"./index-CeVDp2nM.js";import"./index-Bdf3NA1x.js";import"./schemas-nPDmCKRO.js";import"./useSduiLayoutAction-CHoO65-T.js";const k=({id:e})=>{const{attributes:o}=L({nodeId:e}),{referencedNodes:t,hasReference:i}=A({nodeId:e}),p=o?.className,T=o?.options;if(!i||t.length===0)return n.jsx("span",{className:p,children:"No reference"});const l=t[0]?.state?.selectedId,c=T?.find(B=>B.id===l)?.label||l||"None";return n.jsx("span",{className:p,children:c})};k.displayName="ReferenceText";const j=({id:e})=>{const{attributes:o}=L({nodeId:e}),{referencedNodes:t,hasReference:i}=A({nodeId:e}),p=o?.className,T=o?.optionsMap;return i?n.jsx("div",{className:p,children:t.map((a,l)=>{const c=a?.state?.selectedId,M=T?.[a.id]?.find(V=>V.id===c)?.label||c||"None";return n.jsxs("div",{children:[n.jsxs("span",{className:"text-gray-500",children:[a.id,":"]})," ",n.jsx("span",{className:"font-medium",children:M})]},a.id||l)})}):n.jsx("div",{className:p,children:"No references configured"})};j.displayName="ReferenceDisplay";const s={...r,ReferenceText:e=>n.jsx(k,{id:e}),ReferenceDisplay:e=>n.jsx(j,{id:e})},G={title:"Shared/UI/Dropdown",component:E.Root,tags:["autodocs"],parameters:{docs:{description:{component:`
## Overview
