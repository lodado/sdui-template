import{j as e}from"./jsx-runtime-DovMNAqN.js";import{r as u}from"./iframe-BbXRsuiq.js";import{i as s,s as k}from"./sduiComponents-gJE1An-z.js";import{S as f}from"./SduiLayoutRenderer-BGCtHpD_.js";import"./preload-helper-ggYluGXI.js";import"./index-tHm0fs3T.js";import"./index-CTYGotzZ.js";import"./index-BQac6TIy.js";import"./schemas-nPDmCKRO.js";import"./useSduiLayoutAction-CH5luHP-.js";const w={title:"Shared/UI/Toggle",component:s,tags:["autodocs"],argTypes:{size:{control:"select",options:["regular","large"],description:"Toggle size variant",table:{defaultValue:{summary:"regular"}}},isChecked:{control:"boolean",description:"Whether the toggle is checked (controlled)",table:{defaultValue:{summary:"false"}}},isDisabled:{control:"boolean",description:"Whether the toggle is disabled",table:{defaultValue:{summary:"false"}}},isLoading:{control:"boolean",description:"Whether the toggle is in loading state",table:{defaultValue:{summary:"false"}}},label:{control:"text",description:"Accessible label for the toggle"}},parameters:{docs:{description:{component:`
## Overview
