import{j as r}from"./jsx-runtime-G6TLFr6R.js";import{r as s}from"./iframe-Zpr94bE2.js";import"./preload-helper-ggYluGXI.js";const i=`:root,
[data-theme='light'] {
  /* color */
  ...
  --color-background-accent-blue-bolder-pressed: var(--blue-blue900, #123263);
  ...
  --color-background-accent-blue-subtle-pressed: var(--blue-blue200, #cfe1fd);
  --color-background-accent-blue-subtler-default: var(--blue-blue200, #cfe1fd);
  --color-background-accent-blue-subtler-hovered: var(--blue-blue300, #8fb8f6);
  --color-background-accent-blue-subtler-pressed: var(--blue-blue400, #669df1);
  ...
  --color-background-accent-blue-subtlest-pressed: var(--blue-blue300, #8fb8f6);
  ...
  --color-background-accent-lime-lime-pressed: var(--lime-lime900, #37471f);
  ...
  --color-background-accent-orange-bolder-pressed: var(--orange-orange900, #693200);
  ...
  --color-background-accent-orange-subtle-pressed: var(--orange-orange200, #fce4a6);
  --color-background-accent-orange-subtler-default: var(--orange-orange200, #fce4a6);
  --color-background-accent-orange-subtler-hovered: var(--orange-orange300, #fbc828);
  --color-background-accent-orange-subtler-pressed: var(--orange-orange400, #fca700);
  ...
  --color-background-accent-orange-subtlest-pressed: var(--orange-orange300, #fbc828);
  ...
  --color-background-accent-purple-bolder-pressed: var(--purple-purple900, #48245d);
  ...
  --color-background-accent-purple-subtle-pressed: var(--purple-purple200, #eed7fc);
  --color-background-accent-purple-subtler-default: var(--purple-purple200, #eed7fc);
  --color-background-accent-purple-subtler-hovered: var(--purple-purple300, #d8a0f7);
  --color-background-accent-purple-subtler-pressed: var(--purple-purple400, #c97cf4);
  ...
  --color-background-accent-purple-subtlest-pressed: var(--purple-purple300, #d8a0f7);
  ...
  --color-background-accent-yellow-subtler-hovered: var(--yellow-yellow300, #eed12b);
  --color-background-accent-yellow-subtler-pressed: var(--yellow-yellow400, #ddb30e);
  ...
  --color-background-accent-yellow-subtlest-pressed: var(--yellow-yellow300, #eed12b);
  --color-background-brand-bold-default: var(--blue-blue700, #1868db);
  --color-background-brand-bold-hovered: var(--blue-blue800, #1558bc);
  --color-background-brand-bold-pressed: var(--blue-blue900, #123263);
  ...
  --color-background-brand-boldest-pressed: var(--blue-blue800, #1558bc);
  ...
  --color-background-brand-subtlest-pressed: var(--blue-blue300, #8fb8f6);
  ...
  --color-background-discovery-pressed: var(--purple-purple300, #d8a0f7);
  ...
  --color-background-discovery-bold-pressed: var(--purple-purple900, #48245d);
  --color-background-information-default: var(--blue-blue100, #e9f2fe);
  --color-background-information-hovered: var(--blue-blue200, #cfe1fd);
  --color-background-information-pressed: var(--blue-blue300, #8fb8f6);
  ...
  --color-background-information-bold-pressed: var(--blue-blue900, #123263);
  ...
  --color-background-neutral-hovered: var(--neutral-alpha-neutral300a, #0b122824);
  --color-background-neutral-pressed: var(--neutral-alpha-neutral400a, #080f2147);
  ...
  --color-background-neutral-subtle-pressed: var(--neutral-alpha-neutral300a, #0b122824);
  ...
  --color-background-success-pressed: var(--lime-lime300, #b3df72);
  ...
  --color-background-success-bold-pressed: var(--lime-lime900, #37471f);
  --color-background-warning-default: var(--orange-orange100, #fff5db);
  --color-background-warning-hovered: var(--orange-orange200, #fce4a6);
  --color-background-warning-pressed: var(--orange-orange300, #fbc828);
  ...
  --color-border-default: var(--neutral-alpha-neutral300a, #0b122824);
  ...
  --color-chart-categorical-8-hovered: var(--orange-orange800, #9e4c00);
  ...
  --color-chart-discovery-bold-hovered: var(--purple-purple900, #48245d);
  ...
  --color-chart-orange-boldest-default: var(--orange-orange800, #9e4c00);
  ...
  --color-chart-warning-default: var(--orange-orange600, #e06c00);
  --color-chart-warning-hovered: var(--orange-orange700, #bd5b00);
  --color-chart-warning-bold-default: var(--orange-orange800, #9e4c00);
  --color-chart-warning-bold-hovered: var(--orange-orange900, #693200);
  ...
  --color-icon-disabled: var(--neutral-alpha-neutral400a, #080f2147);
  ...
  --color-text-disabled: var(--neutral-alpha-neutral400a, #080f2147);
  ...
  --color-ω-dst-team-only---logo-border-brand-data-center: var(--neutral-opaque-neutral300, #dddee1);
  --color-ω-dst-team-only---logo-border-inverse-data-center: var(--neutral-opaque-neutral0, #ffffff);
  --color-ω-dst-team-only---logo-border-neutral-data-center: var(--neutral-opaque-neutral800, #505258);
  --color-ω-dst-team-only---logo-container-brand-data-center: var(--neutral-opaque-neutral0, #ffffff);
  --color-ω-dst-team-only---logo-container-brand-dev: var(--lime-lime400, #94c748);
  --color-ω-dst-team-only---logo-container-brand-loom: #625df5;
  --color-ω-dst-team-only---logo-container-brand-platform: var(--neutral-opaque-neutral300, #dddee1);
  --color-ω-dst-team-only---logo-container-brand-product: var(--purple-purple400, #c97cf4);
  --color-ω-dst-team-only---logo-container-brand-service: #ffc716;
  --color-ω-dst-team-only---logo-container-brand-strategy: #fb9700;
  --color-ω-dst-team-only---logo-container-brand-teamwork: var(--blue-blue700, #1868db);
  --color-ω-dst-team-only---logo-container-brand-trello: var(--blue-blue800, #1558bc);
  --color-ω-dst-team-only---logo-container-inverse-data-center: var(--neutral-opaque-neutral1100, #1e1f21);
  --color-ω-dst-team-only---logo-container-inverse-default: var(--neutral-opaque-neutral0, #ffffff);
  --color-ω-dst-team-only---logo-container-neutral-data-center: var(--neutral-opaque-neutral300, #dddee1);
  --color-ω-dst-team-only---logo-container-neutral-default: var(--neutral-opaque-neutral300, #dddee1);
  --color-ω-dst-team-only---logo-icon-brand-data-center: var(--blue-blue700, #1868db);
  --color-ω-dst-team-only---logo-icon-brand-default: #101214;
  --color-ω-dst-team-only---logo-icon-brand-legacy-logos: var(--blue-blue700, #1868db);
  --color-ω-dst-team-only---logo-icon-brand-loom: #ffffff;
  --color-ω-dst-team-only---logo-icon-brand-teamwork: #ffffff;
  --color-ω-dst-team-only---logo-icon-brand-trello: #ffffff;
  --color-ω-dst-team-only---logo-icon-inverse-data-center: var(--neutral-opaque-neutral0, #ffffff);
  --color-ω-dst-team-only---logo-icon-inverse-default: var(--neutral-opaque-neutral1100, #1e1f21);
  --color-ω-dst-team-only---logo-icon-inverse-legacy-logos: var(--neutral-opaque-neutral0, #ffffff);
  --color-ω-dst-team-only---logo-icon-neutral-data-center: var(--neutral-opaque-neutral800, #505258);
  --color-ω-dst-team-only---logo-icon-neutral-default: var(--neutral-opaque-neutral800, #505258);
  --color-ω-dst-team-only---logo-icon-neutral-legacy-logos: var(--neutral-opaque-neutral700, #6b6e76);
  --color-ω-dst-team-only---logo-text-brand-default: #101214;
  --color-ω-dst-team-only---logo-text-brand-legacy-logos-primary: var(--blue-blue700, #1868db);
  --color-ω-dst-team-only---logo-text-brand-legacy-logos-secondary: #101214;
  --color-ω-dst-team-only---logo-text-inverse-default: var(--neutral-opaque-neutral0, #ffffff);
  --color-ω-dst-team-only---logo-text-neutral-default: var(--neutral-opaque-neutral800, #505258);
  --color-ω-dst-team-only---logo-text-neutral-legacy-logos-primary: var(--neutral-opaque-neutral700, #6b6e76);
  --color-ω-dst-team-only---logo-text-neutral-legacy-logos-secondary: var(--neutral-opaque-neutral900, #3b3d42);
...
[data-theme='dark'] {
  /* color */
  --color-background-disabled: var(--dark-neutral-alpha-dark-neutral-100a, #01040475);
  ...
  --color-background-accent-blue-bolder-pressed: var(--blue-blue200, #cfe1fd);
  --color-background-accent-blue-subtle-default: var(--blue-blue800, #1558bc);
  --color-background-accent-blue-subtle-hovered: var(--blue-blue900, #123263);
  --color-background-accent-blue-subtle-pressed: var(--blue-blue1000, #1c2b42);
  --color-background-accent-blue-subtler-default: var(--blue-blue900, #123263);
  --color-background-accent-blue-subtler-hovered: var(--blue-blue800, #1558bc);
  --color-background-accent-blue-subtler-pressed: var(--blue-blue700, #1868db);
  ...
  --color-background-accent-blue-subtlest-pressed: var(--blue-blue800, #1558bc);
  ...
  --color-background-accent-lime-lime-pressed: var(--lime-lime200, #d3f1a7);
  ...
  --color-background-accent-orange-bolder-pressed: var(--orange-orange200, #fce4a6);
  --color-background-accent-orange-subtle-default: var(--orange-orange800, #9e4c00);
  --color-background-accent-orange-subtle-hovered: var(--orange-orange900, #693200);
  --color-background-accent-orange-subtle-pressed: var(--orange-orange1000, #3a2c1f);
  --color-background-accent-orange-subtler-default: var(--orange-orange900, #693200);
  --color-background-accent-orange-subtler-hovered: var(--orange-orange800, #9e4c00);
  --color-background-accent-orange-subtler-pressed: var(--orange-orange700, #bd5b00);
  ...
  --color-background-accent-orange-subtlest-pressed: var(--orange-orange800, #9e4c00);
  ...
  --color-background-accent-purple-bolder-pressed: var(--purple-purple200, #eed7fc);
  --color-background-accent-purple-subtle-default: var(--purple-purple800, #803fa5);
  --color-background-accent-purple-subtle-hovered: var(--purple-purple900, #48245d);
  --color-background-accent-purple-subtle-pressed: var(--purple-purple1000, #35243f);
  --color-background-accent-purple-subtler-default: var(--purple-purple900, #48245d);
  --color-background-accent-purple-subtler-hovered: var(--purple-purple800, #803fa5);
  --color-background-accent-purple-subtler-pressed: var(--purple-purple700, #964ac0);
  ...
  --color-background-accent-purple-subtlest-pressed: var(--purple-purple800, #803fa5);
  ...
  --color-background-accent-yellow-bolder-pressed: var(--yellow-yellow200, #f5e989);
  ...
  --color-background-brand-bold-pressed: var(--blue-blue200, #cfe1fd);
  ...
  --color-background-brand-boldest-pressed: var(--blue-blue300, #8fb8f6);
  ...
  --color-background-brand-subtlest-pressed: var(--blue-blue800, #1558bc);
  ...
  --color-background-discovery-pressed: var(--purple-purple800, #803fa5);
  ...
  --color-background-discovery-bold-pressed: var(--purple-purple200, #eed7fc);
  ...
  --color-background-information-pressed: var(--blue-blue800, #1558bc);
  ...
  --color-background-information-bold-pressed: var(--blue-blue200, #cfe1fd);
  ...
  --color-background-success-pressed: var(--lime-lime800, #4c6b1f);
  ...
  --color-background-success-bold-pressed: var(--lime-lime200, #d3f1a7);
  ...
  --color-background-warning-pressed: var(--orange-orange800, #9e4c00);
  --color-background-warning-bold-default: var(--orange-orange300, #fbc828);
  --color-background-warning-bold-hovered: var(--orange-orange400, #fca700);
  --color-background-warning-bold-pressed: var(--orange-orange500, #f68909);
  ...
  --color-chart-categorical-8-hovered: var(--orange-orange500, #f68909);
  --color-chart-danger-default: var(--red-red600, #e2483d);
  --color-chart-danger-hovered: var(--red-red500, #f15b50);
  --color-chart-danger-bold-default: var(--red-red400, #f87168);
  ...
  --color-chart-orange-boldest-default: var(--orange-orange300, #fbc828);
  ...
  --color-icon-accent-red: var(--red-red500, #f15b50);
  ...
  --color-ω-dst-team-only---logo-border-brand-data-center: var(--dark-neutral-opaque-dark-neutral400, #4b4d51);
  --color-ω-dst-team-only---logo-border-inverse-data-center: var(--dark-neutral-opaque-dark-neutral100, #1f1f21);
  --color-ω-dst-team-only---logo-border-neutral-data-center: var(--dark-neutral-opaque-dark-neutral800, #a9abaf);
  --color-ω-dst-team-only---logo-container-brand-data-center: var(--dark-neutral-opaque-dark-neutral100, #1f1f21);
  --color-ω-dst-team-only---logo-container-brand-dev: var(--lime-lime400, #94c748);
  --color-ω-dst-team-only---logo-container-brand-loom: #625df5;
  --color-ω-dst-team-only---logo-container-brand-platform: var(--neutral-opaque-neutral300, #dddee1);
  --color-ω-dst-team-only---logo-container-brand-product: var(--purple-purple400, #c97cf4);
  ...
  --color-ω-dst-team-only---logo-container-brand-teamwork: var(--blue-blue700, #1868db);
  --color-ω-dst-team-only---logo-container-brand-trello: var(--blue-blue800, #1558bc);
  --color-ω-dst-team-only---logo-container-inverse-data-center: var(--neutral-opaque-neutral0, #ffffff);
  --color-ω-dst-team-only---logo-container-inverse-default: var(--dark-neutral-opaque-dark-neutral100, #1f1f21);
  --color-ω-dst-team-only---logo-container-neutral-data-center: var(--dark-neutral-opaque-dark-neutral400, #4b4d51);
  --color-ω-dst-team-only---logo-container-neutral-default: var(--dark-neutral-opaque-dark-neutral400, #4b4d51);
  --color-ω-dst-team-only---logo-icon-brand-data-center: var(--blue-blue700, #1868db);
  --color-ω-dst-team-only---logo-icon-brand-default: #101214;
  --color-ω-dst-team-only---logo-icon-brand-legacy-logos: var(--blue-blue600, #357de8);
  --color-ω-dst-team-only---logo-icon-brand-loom: #ffffff;
  --color-ω-dst-team-only---logo-icon-brand-teamwork: #ffffff;
  --color-ω-dst-team-only---logo-icon-brand-trello: #ffffff;
  --color-ω-dst-team-only---logo-icon-inverse-data-center: var(--dark-neutral-opaque-dark-neutral100, #1f1f21);
  --color-ω-dst-team-only---logo-icon-inverse-default: var(--neutral-opaque-neutral0, #ffffff);
  --color-ω-dst-team-only---logo-icon-inverse-legacy-logos: var(--dark-neutral-opaque-dark-neutral100, #1f1f21);
  --color-ω-dst-team-only---logo-icon-neutral-data-center: var(--dark-neutral-opaque-dark-neutral800, #a9abaf);
  --color-ω-dst-team-only---logo-icon-neutral-default: var(--dark-neutral-opaque-dark-neutral800, #a9abaf);
  --color-ω-dst-team-only---logo-icon-neutral-legacy-logos: var(--dark-neutral-opaque-dark-neutral700, #96999e);
  --color-ω-dst-team-only---logo-text-brand-default: var(--dark-neutral-opaque-dark-neutral1000, #cecfd2);
  --color-ω-dst-team-only---logo-text-brand-legacy-logos-primary: var(--blue-blue600, #357de8);
  --color-ω-dst-team-only---logo-text-brand-legacy-logos-secondary: var(
    --dark-neutral-opaque-dark-neutral1100,
    #e2e3e4
  );
  --color-ω-dst-team-only---logo-text-inverse-default: var(--dark-neutral-opaque-dark-neutral100, #1f1f21);
  --color-ω-dst-team-only---logo-text-neutral-default: var(--dark-neutral-opaque-dark-neutral800, #a9abaf);
  --color-ω-dst-team-only---logo-text-neutral-legacy-logos-primary: var(--dark-neutral-opaque-dark-neutral700, #96999e);
  --color-ω-dst-team-only---logo-text-neutral-legacy-logos-secondary: var(
    --dark-neutral-opaque-dark-neutral900,
    #bfc1c4
  );
  --elevation-shadow-overflow-color: #ffffff;
...
:root {
  ...
  --radius-xl: 0.1875rem;
  --radius-xs: 0.1875rem;
  --radius-tile-size-16: var(--radius04, 0.25rem);
  --radius-tile-size-20: var(--radius05, 0.3125rem);
  --radius-tile-size-24: var(--radius06, 0.375rem);
  --radius-tile-size-32: var(--radius08, 0.5rem);
  --radius-tile-size-40: var(--radius10, 0.625rem);
  --radius-tile-size-48: var(--radius12, 0.75rem);
  --radius-full-round: var(--radius99, 6.1875rem);
}
:root {
  /* number */
