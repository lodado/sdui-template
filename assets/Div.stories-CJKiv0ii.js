import{j as s}from"./jsx-runtime-mA-n-d6H.js";import{c as d,s as i}from"./sduiComponents-Bh5wK3mF.js";import{S as a}from"./SduiLayoutRenderer-Dnhr9FUr.js";import"./iframe-CBmONYCU.js";import"./preload-helper-ggYluGXI.js";import"./index-CDV7cqJ4.js";import"./index-CynUYlTt.js";import"./index-dCEBnlvI.js";import"./index-DP-BN3tX.js";import"./index-CcR-zJDu.js";import"./Button-DwzDj1Tt.js";import"./schemas-BKIZ752n.js";const D={title:"Shared/UI/Div",component:d,tags:["autodocs"],parameters:{docs:{description:{component:`
## Overview
...
- Maintain design system tokens
        `}}}},o={render:()=>{const t={version:"1.0.0",root:{id:"root",type:"Div",attributes:{className:"p-6"},children:[{id:"title",type:"Span",state:{text:"Container Example"},attributes:{className:"text-lg font-bold mb-4"}},{id:"container-div",type:"Div",attributes:{className:"flex flex-col gap-4 p-4 border border-gray-300 rounded"},children:[{id:"item-1",type:"Span",state:{text:"Item 1"},attributes:{className:"p-2 bg-gray-100 rounded"}},{id:"item-2",type:"Span",state:{text:"Item 2"},attributes:{className:"p-2 bg-gray-100 rounded"}},{id:"item-3",type:"Span",state:{text:"Item 3"},attributes:{className:"p-2 bg-gray-100 rounded"}}]}]}};return s.jsx(a,{document:t,components:i})},parameters:{docs:{description:{story:`
## Overview
...
}`,...o.parameters?.docs?.source}}};const w=["Default","NestedDivs","WithCustomStyling","AsContainer"];export{o as AsContainer,e as Default,n as NestedDivs,r as WithCustomStyling,w as __namedExportsOrder,D as default};
