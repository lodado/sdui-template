import{j as n}from"./jsx-runtime-mA-n-d6H.js";import"./marked.esm-CEb0ui0X.js";import{t as p}from"./toSduiLayout-DQvzG4Yh.js";import{r as a}from"./iframe-CBmONYCU.js";import{S as E}from"./SduiLayoutStateInspector-CLherFMb.js";import{S as T}from"./SduiDocumentEditor-DoX-MrUG.js";function L(e){return"blockId"in e?e.blockId:"block"in e?e.block.id:""}function O(e){const{type:t}=e,o=L(e);return o?`${t}  ${o}`:t}const y=({patches:e})=>e.length===0?n.jsx("pre",{className:"sdui-doc__log",children:"문서를 편집하면 여기에 패치가 순서대로 쌓입니다."}):n.jsx("pre",{className:"sdui-doc__log",children:e.slice(-10).map((t,o)=>`${String(e.length-Math.min(10,e.length)+o+1).padStart(2,"0")}  ${O(t)}`).join(`
