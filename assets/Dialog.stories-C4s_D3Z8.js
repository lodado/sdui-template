import{j as e}from"./jsx-runtime-CaSxwcFh.js";import{c as a,S as o,s as i,d as x,D as n}from"./sduiComponents-BFyGNe-6.js";import"./iframe-BdcrWAEZ.js";import"./preload-helper-ggYluGXI.js";import"./index-DB106I7w.js";import"./index-CGp91DWD.js";import"./index-CAPwL_uH.js";const w={title:"Features/UI/Dialog",component:a,tags:["autodocs"],argTypes:{size:{control:"select",options:["small","medium","large","xlarge"],description:"Dialog size",table:{defaultValue:{summary:"small"}}},hasCloseButton:{control:"boolean",description:"Whether to show close button",table:{defaultValue:{summary:"true"}}},title:{control:"text",description:"Dialog title"},description:{control:"text",description:"Dialog description (optional)"}},parameters:{docs:{description:{component:`
## Overview
...
}`,...D.parameters?.docs?.source}}};const z=["Playground","SizeSmall","SizeMedium","SizeLarge","SizeXLarge","AppearanceDefault","AppearanceDanger","AppearanceWarning","WithFormContent","ConfirmationPattern","CompoundPatternExample","AllSizes"];export{D as AllSizes,g as AppearanceDanger,p as AppearanceDefault,m as AppearanceWarning,h as CompoundPatternExample,y as ConfirmationPattern,r as Playground,d as SizeLarge,s as SizeMedium,l as SizeSmall,c as SizeXLarge,u as WithFormContent,z as __namedExportsOrder,w as default};
