import{j as e}from"./jsx-runtime-DPNyDcdb.js";import{r as u}from"./iframe-CVwGxfdm.js";import{i as s,s as k}from"./sduiComponents-DFbfSH7v.js";import{S as f}from"./SduiLayoutRenderer-J8GNyr-T.js";import"./preload-helper-ggYluGXI.js";import"./index-1O1z8YHx.js";import"./index-BFCOPqJ0.js";import"./index-CHZAGaFf.js";import"./index-zmiVSS4z.js";import"./schemas-BKIZ752n.js";const w={title:"Shared/UI/Toggle",component:s,tags:["autodocs"],argTypes:{size:{control:"select",options:["regular","large"],description:"Toggle size variant",table:{defaultValue:{summary:"regular"}}},isChecked:{control:"boolean",description:"Whether the toggle is checked (controlled)",table:{defaultValue:{summary:"false"}}},isDisabled:{control:"boolean",description:"Whether the toggle is disabled",table:{defaultValue:{summary:"false"}}},isLoading:{control:"boolean",description:"Whether the toggle is in loading state",table:{defaultValue:{summary:"false"}}},label:{control:"text",description:"Accessible label for the toggle"}},parameters:{docs:{description:{component:`
## Overview
