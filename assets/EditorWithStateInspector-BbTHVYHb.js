import{j as n}from"./jsx-runtime-SONeQbs_.js";import"./marked.esm-DvVwiqbt.js";import{t as _}from"./toSduiLayout-EeX76f66.js";import{r as a}from"./iframe-wXaJxiyW.js";import{S as y}from"./SduiDocumentEditor-CP-IcUWa.js";import{S as g}from"./SduiLayoutStateInspector-PPVx8qFZ.js";function E(e){return"blockId"in e?e.blockId:"block"in e?e.block.id:""}function L(e){const{type:t}=e,r=E(e);return r?`${t}  ${r}`:t}const T=({patches:e})=>e.length===0?n.jsx("pre",{className:"sdui-doc__log",children:"문서를 편집하면 여기에 패치가 순서대로 쌓입니다."}):n.jsx("pre",{className:"sdui-doc__log",children:e.slice(-10).map((t,r)=>`${String(e.length-Math.min(10,e.length)+r+1).padStart(2,"0")}  ${L(t)}`).join(`
`)}),f=({content:e})=>n.jsxs("section",{"aria-label":"SduiDocumentContent",style:{display:"grid",gap:8},children:[n.jsx("strong",{style:{fontSize:13},children:"Domain · SduiDocumentContent"}),n.jsx("pre",{style:{margin:0,padding:12,borderRadius:8,border:"1px solid #cbd5e1",background:"#fff7ed",color:"#0f172a",overflow:"auto",maxHeight:280,fontSize:12,lineHeight:1.45,whiteSpace:"pre-wrap",wordBreak:"break-word"},children:JSON.stringify(e,null,2)})]}),C=({content:e,readOnly:t,documentId:r="storybook-doc",title:o="Editor → SDUI layout state"})=>{const[i,s]=a.useState(e),[u,d]=a.useState([]),l=a.useMemo(()=>_(i,{documentId:r,title:o}),[i,r,o]);return n.jsxs("div",{style:{display:"grid",gap:16,gridTemplateColumns:"minmax(0, 1.1fr) minmax(0, 0.9fr)",alignItems:"start"},children:[n.jsxs("div",{style:{display:"grid",gap:12},children:[n.jsx(y,{content:e,readOnly:t,onContentChange:(m,c)=>{s(m),d(p=>[...p,...c])}}),!t&&n.jsx(T,{patches:u})]}),n.jsxs("div",{style:{display:"grid",gap:12},children:[n.jsx(f,{content:i}),n.jsx(g,{document:l,title:o,maxHeight:420})]})]})};C.__docgenInfo={description:`SduiDocumentEditor + live domain/layout JSON panels for Storybook debugging.
...
| typeof COLUMN_BLOCK_TYPE`,elements:[{name:"ROOT_BLOCK_TYPE"},{name:"PARAGRAPH_BLOCK_TYPE"},{name:"HEADING_BLOCK_TYPE"},{name:"BULLETED_LIST_BLOCK_TYPE"},{name:"NUMBERED_LIST_BLOCK_TYPE"},{name:"CHECKLIST_BLOCK_TYPE"},{name:"DIVIDER_BLOCK_TYPE"},{name:"CALLOUT_BLOCK_TYPE"},{name:"IMAGE_BLOCK_TYPE"},{name:"FILE_BLOCK_TYPE"},{name:"LINK_BLOCK_TYPE"},{name:"QUOTE_BLOCK_TYPE"},{name:"TOGGLE_BLOCK_TYPE"},{name:"CODE_BLOCK_TYPE"},{name:"COLUMN_LIST_BLOCK_TYPE"},{name:"COLUMN_BLOCK_TYPE"}]},{name:"unknown"}],required:!0}},{key:"position",value:{name:"string",required:!1},description:"Fractional ordering key among siblings (root block omits this)."},{key:"origin",value:{name:"signature",type:"object",raw:`{
  clientId: string
  opId: string
