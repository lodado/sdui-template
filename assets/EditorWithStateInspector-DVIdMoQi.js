import{j as n}from"./jsx-runtime-BXkhSATe.js";import"./marked.esm-EAW_3-AJ.js";import{t as _}from"./toSduiLayout-D-oBgYlR.js";import{r as a}from"./iframe-NUoFiL0j.js";import{S as y}from"./SduiDocumentEditor-BgvktcW4.js";import{S as E}from"./SduiLayoutStateInspector-DQaHmXku.js";function g(e){return"blockId"in e?e.blockId:"block"in e?e.block.id:""}function L(e){const{type:t}=e,r=g(e);return r?`${t}  ${r}`:t}const T=({patches:e})=>e.length===0?n.jsx("pre",{className:"sdui-doc__log",children:"문서를 편집하면 여기에 패치가 순서대로 쌓입니다."}):n.jsx("pre",{className:"sdui-doc__log",children:e.slice(-10).map((t,r)=>`${String(e.length-Math.min(10,e.length)+r+1).padStart(2,"0")}  ${L(t)}`).join(`
