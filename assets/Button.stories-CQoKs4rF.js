import{j as e}from"./jsx-runtime-_1jvc9L0.js";import{a as C,S as a,s as r}from"./sduiComponents-BS8e01iU.js";import"./iframe-jzwLdUya.js";import"./preload-helper-ggYluGXI.js";import"./index-Ik36_hCC.js";import"./index-CxOifdYY.js";const W={title:"Shared/UI/Button",component:C,tags:["autodocs"],argTypes:{appearance:{control:"select",options:["default","primary","subtle","warning","danger"],description:"Button appearance style",table:{defaultValue:{summary:"default"}}},spacing:{control:"select",options:["default","compact"],description:"Button spacing (size)",table:{defaultValue:{summary:"default"}}},isDisabled:{control:"boolean",description:"Whether the button is disabled",table:{defaultValue:{summary:"false"}}},isLoading:{control:"boolean",description:"Whether the button is in loading state",table:{defaultValue:{summary:"false"}}},isSelected:{control:"boolean",description:"Whether the button is selected (toggle state)",table:{defaultValue:{summary:"false"}}}},parameters:{docs:{description:{component:`
## Overview
