import{j as e}from"./jsx-runtime-BDcnKkQN.js";import{a as C,s as a}from"./sduiComponents-DAozQnRg.js";import{S as r}from"./SduiLayoutRenderer-EIpWCah8.js";import"./iframe-DJ69XQwm.js";import"./preload-helper-ggYluGXI.js";import"./index-C3rzyWFX.js";import"./index-CnzO2P-b.js";import"./index-Cd2e6MZi.js";import"./index-CeLOyPbQ.js";import"./schemas-DwlGupW0.js";import"./useSduiLayoutAction-BBxdgFwF.js";const M={title:"Shared/UI/Button",component:C,tags:["autodocs"],argTypes:{appearance:{control:"select",options:["default","primary","subtle","warning","danger"],description:"Button appearance style",table:{defaultValue:{summary:"default"}}},spacing:{control:"select",options:["default","compact"],description:"Button spacing (size)",table:{defaultValue:{summary:"default"}}},isDisabled:{control:"boolean",description:"Whether the button is disabled",table:{defaultValue:{summary:"false"}}},isLoading:{control:"boolean",description:"Whether the button is in loading state",table:{defaultValue:{summary:"false"}}},isSelected:{control:"boolean",description:"Whether the button is selected (toggle state)",table:{defaultValue:{summary:"false"}}}},parameters:{docs:{description:{component:`
## Overview
...
- **isSelected**: Toggle selected state
        `}}}},p={render:()=>{const t={version:"1.0.0",root:{id:"root",type:"Div",attributes:{className:"flex items-center justify-center p-4 gap-4"},children:[{id:"btn-default",type:"Button",state:{appearance:"default"},children:[{id:"text",type:"Span",state:{text:"Default"}}]}]}};return e.jsx(r,{document:t,components:a})},parameters:{docs:{description:{story:`
## Default Appearance
...
- \`--color-text-default\` for text color
        `}}}},d={render:()=>{const t={version:"1.0.0",root:{id:"root",type:"Div",attributes:{className:"flex items-center justify-center p-4 gap-4"},children:[{id:"btn-primary",type:"Button",state:{appearance:"primary"},children:[{id:"text",type:"Span",state:{text:"Primary"}}]}]}};return e.jsx(r,{document:t,components:a})},parameters:{docs:{description:{story:`
## Primary Appearance
...
- Use for the most important action on a page
        `}}}},l={render:()=>{const t={version:"1.0.0",root:{id:"root",type:"Div",attributes:{className:"flex items-center justify-center p-4 gap-4"},children:[{id:"btn-subtle",type:"Button",state:{appearance:"subtle"},children:[{id:"text",type:"Span",state:{text:"Subtle"}}]}]}};return e.jsx(r,{document:t,components:a})},parameters:{docs:{description:{story:`
## Subtle Appearance
...
- Use for tertiary actions or link-like buttons
        `}}}},u={render:()=>{const t={version:"1.0.0",root:{id:"root",type:"Div",attributes:{className:"flex items-center justify-center p-4 gap-4"},children:[{id:"btn-warning",type:"Button",state:{appearance:"warning"},children:[{id:"text",type:"Span",state:{text:"Warning"}}]}]}};return e.jsx(r,{document:t,components:a})},parameters:{docs:{description:{story:`
## Warning Appearance
...
- Use for actions that need user attention but aren't destructive
        `}}}},m={render:()=>{const t={version:"1.0.0",root:{id:"root",type:"Div",attributes:{className:"flex items-center justify-center p-4 gap-4"},children:[{id:"btn-danger",type:"Button",state:{appearance:"danger"},children:[{id:"text",type:"Span",state:{text:"Danger"}}]}]}};return e.jsx(r,{document:t,components:a})},parameters:{docs:{description:{story:`
## Danger Appearance
...
- Use for delete, remove, or other destructive actions
        `}}}},b={render:()=>{const t={version:"1.0.0",root:{id:"root",type:"Div",attributes:{className:"flex items-center justify-center p-4 gap-4"},children:[{id:"btn-default-spacing",type:"Button",state:{appearance:"primary",spacing:"default"},children:[{id:"text",type:"Span",state:{text:"Default (32px)"}}]}]}};return e.jsx(r,{document:t,components:a})},parameters:{docs:{description:{story:`
## Default Spacing
...
- **Font size**: 12px
        `}}}},y={render:()=>{const t={version:"1.0.0",root:{id:"root",type:"Div",attributes:{className:"flex items-center justify-center p-4 gap-4"},children:[{id:"btn-disabled",type:"Button",state:{appearance:"primary",isDisabled:!0},children:[{id:"text",type:"Span",state:{text:"Disabled"}}]}]}};return e.jsx(r,{document:t,components:a})},parameters:{docs:{description:{story:`
## Disabled State
...
- \`aria-disabled="true"\` for accessibility
        `}}}},x={render:()=>{const t={version:"1.0.0",root:{id:"root",type:"Div",attributes:{className:"flex items-center justify-center p-4 gap-4"},children:[{id:"btn-loading",type:"Button",state:{appearance:"primary",isLoading:!0},children:[{id:"text",type:"Span",state:{text:"Loading..."}}]}]}};return e.jsx(r,{document:t,components:a})},parameters:{docs:{description:{story:`
## Loading State
...
- Icons are hidden during loading
        `}}}},g={render:()=>{const t={version:"1.0.0",root:{id:"root",type:"Div",attributes:{className:"flex items-center justify-center p-4 gap-4"},children:[{id:"btn-selected",type:"Button",state:{appearance:"default",isSelected:!0},children:[{id:"text",type:"Span",state:{text:"Selected"}}]}]}};return e.jsx(r,{document:t,components:a})},parameters:{docs:{description:{story:`
## Selected State
...
| Compact | 24px | 8px | 12px |
        `}}}},N={render:()=>{const s={version:"1.0.0",root:{id:"root",type:"Div",attributes:{className:"flex flex-col gap-6 p-6"},children:[{id:"title",type:"Span",state:{text:"States Matrix"},attributes:{className:"text-xl font-bold mb-4"}},{id:"header",type:"Div",attributes:{className:"grid grid-cols-6 gap-4 items-center mb-2"},children:[{id:"h-appearance",type:"Span",state:{text:"Appearance"},attributes:{className:"font-bold"}},{id:"h-default",type:"Span",state:{text:"Default"},attributes:{className:"text-center text-sm"}},{id:"h-disabled",type:"Span",state:{text:"Disabled"},attributes:{className:"text-center text-sm"}},{id:"h-loading",type:"Span",state:{text:"Loading"},attributes:{className:"text-center text-sm"}},{id:"h-selected",type:"Span",state:{text:"Selected"},attributes:{className:"text-center text-sm"}},{id:"h-hover",type:"Span",state:{text:"Hover (try)"},attributes:{className:"text-center text-sm"}}]},...["default","primary","subtle","warning","danger"].map(n=>({id:`row-${n}`,type:"Div",attributes:{className:"grid grid-cols-6 gap-4 items-center"},children:[{id:`label-${n}`,type:"Span",state:{text:n.charAt(0).toUpperCase()+n.slice(1)},attributes:{className:"font-medium capitalize"}},{id:`btn-default-${n}`,type:"Button",state:{appearance:n},children:[{id:`text-default-${n}`,type:"Span",state:{text:"Button"}}]},{id:`btn-disabled-${n}`,type:"Button",state:{appearance:n,isDisabled:!0},children:[{id:`text-disabled-${n}`,type:"Span",state:{text:"Button"}}]},{id:`btn-loading-${n}`,type:"Button",state:{appearance:n,isLoading:!0},children:[{id:`text-loading-${n}`,type:"Span",state:{text:"Button"}}]},{id:`btn-selected-${n}`,type:"Button",state:{appearance:n,isSelected:!0},children:[{id:`text-selected-${n}`,type:"Span",state:{text:"Button"}}]},{id:`btn-hover-${n}`,type:"Button",state:{appearance:n},children:[{id:`text-hover-${n}`,type:"Span",state:{text:"Button"}}]}]}))]}};return e.jsx(r,{document:s,components:a})},parameters:{docs:{description:{story:`
