import{j as e}from"./jsx-runtime-CZLhImQn.js";import{r as u}from"./iframe-B8KYAuVr.js";import{i as s,s as k}from"./sduiComponents-B-2yCxvD.js";import{S as f}from"./SduiLayoutRenderer-CJW1mZI8.js";import"./preload-helper-ggYluGXI.js";import"./index-DsyjPEvF.js";import"./index-DIjnaTkK.js";import"./index-BkkYwL6C.js";import"./index-Cmn6teYt.js";import"./schemas-BKIZ752n.js";const w={title:"Shared/UI/Toggle",component:s,tags:["autodocs"],argTypes:{size:{control:"select",options:["regular","large"],description:"Toggle size variant",table:{defaultValue:{summary:"regular"}}},isChecked:{control:"boolean",description:"Whether the toggle is checked (controlled)",table:{defaultValue:{summary:"false"}}},isDisabled:{control:"boolean",description:"Whether the toggle is disabled",table:{defaultValue:{summary:"false"}}},isLoading:{control:"boolean",description:"Whether the toggle is in loading state",table:{defaultValue:{summary:"false"}}},label:{control:"text",description:"Accessible label for the toggle"}},parameters:{docs:{description:{component:`
## Overview
