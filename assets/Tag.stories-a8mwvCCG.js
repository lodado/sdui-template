import{j as e}from"./jsx-runtime-mA-n-d6H.js";import{T as t,s as g}from"./sduiComponents-Bh5wK3mF.js";import{S as m}from"./SduiLayoutRenderer-Dnhr9FUr.js";import"./iframe-CBmONYCU.js";import"./preload-helper-ggYluGXI.js";import"./index-CDV7cqJ4.js";import"./index-CynUYlTt.js";import"./index-dCEBnlvI.js";import"./index-DP-BN3tX.js";import"./index-CcR-zJDu.js";import"./Button-DwzDj1Tt.js";import"./schemas-BKIZ752n.js";const D={title:"Shared/UI/Tag",component:t,tags:["autodocs"],argTypes:{text:{control:"text",description:"Tag text content",table:{defaultValue:{summary:"Tag"}}},color:{control:"select",options:["standard","blue","red","yellow","green","teal","purple","grey","lime","orange","magenta"],description:"Tag color variant",table:{defaultValue:{summary:"standard"}}}},parameters:{docs:{description:{component:`
## Overview
...
\`\`\`
        `}}}},u={render:()=>{const r={version:"1.0.0",root:{id:"root",type:"Div",attributes:{className:"flex flex-col gap-6 p-6"},children:[{id:"title",type:"Span",state:{text:"Tag Colors Matrix"},attributes:{className:"text-xl font-bold"}},{id:"subtitle",type:"Span",state:{text:"11 Color Variants"},attributes:{className:"text-sm text-gray-600 mb-4"}},{id:"tags-grid",type:"Div",attributes:{className:"grid grid-cols-4 gap-4"},children:["standard","blue","red","yellow","green","teal","purple","grey","lime","orange","magenta"].map(o=>({id:`tag-${o}`,type:"Tag",state:{text:o.charAt(0).toUpperCase()+o.slice(1),color:o}}))}]}};return e.jsx(m,{document:r,components:g})},parameters:{docs:{description:{story:`
...
}`,...u.parameters?.docs?.source}}};const I=["Playground","ColorStandard","ColorBlue","ColorRed","AllColors","WithIcon","SduiIntegration","ColorsMatrix"];export{i as AllColors,c as ColorBlue,l as ColorRed,s as ColorStandard,u as ColorsMatrix,n as Playground,p as SduiIntegration,d as WithIcon,I as __namedExportsOrder,D as default};
