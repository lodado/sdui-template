import{j as e}from"./jsx-runtime-CKw7595g.js";import{r as u}from"./iframe-Br0GjfgR.js";import{i as s,s as k}from"./sduiComponents-2o6VQbik.js";import{S as f}from"./SduiLayoutRenderer-row3XsUT.js";import"./preload-helper-ggYluGXI.js";import"./index-C6SUip3G.js";import"./index-3nJ-MBuL.js";import"./index-CahUcFe-.js";import"./index-xUagGUUQ.js";import"./schemas-D-ljss90.js";const w={title:"Shared/UI/Toggle",component:s,tags:["autodocs"],argTypes:{size:{control:"select",options:["regular","large"],description:"Toggle size variant",table:{defaultValue:{summary:"regular"}}},isChecked:{control:"boolean",description:"Whether the toggle is checked (controlled)",table:{defaultValue:{summary:"false"}}},isDisabled:{control:"boolean",description:"Whether the toggle is disabled",table:{defaultValue:{summary:"false"}}},isLoading:{control:"boolean",description:"Whether the toggle is in loading state",table:{defaultValue:{summary:"false"}}},label:{control:"text",description:"Accessible label for the toggle"}},parameters:{docs:{description:{component:`
## Overview
