import{j as s}from"./jsx-runtime-mA-n-d6H.js";import{C as d,s as i}from"./sduiComponents-Bh5wK3mF.js";import{S as o}from"./SduiLayoutRenderer-Dnhr9FUr.js";import"./iframe-CBmONYCU.js";import"./preload-helper-ggYluGXI.js";import"./index-CDV7cqJ4.js";import"./index-CynUYlTt.js";import"./index-dCEBnlvI.js";import"./index-DP-BN3tX.js";import"./index-CcR-zJDu.js";import"./Button-DwzDj1Tt.js";import"./schemas-BKIZ752n.js";const C={title:"Shared/UI/Card",component:d,tags:["autodocs"],parameters:{docs:{description:{component:`
## Overview
...
- Information panels
- List containers
        `}}}},t={render:()=>{const e={version:"1.0.0",root:{id:"root",type:"Div",attributes:{className:"p-4"},children:[{id:"card-1",type:"Card",attributes:{},children:[{id:"card-content",type:"Span",state:{text:"Card content goes here"},attributes:{className:"text-[var(--color-text-default)]"}}]}]}};return s.jsx(o,{document:e,components:i})},parameters:{docs:{description:{story:`
## Overview
...
This is the recommended starting point for most card implementations. Use this variant for grouping related content.
        `}}}},n={render:()=>{const e={version:"1.0.0",root:{id:"root",type:"Div",attributes:{className:"p-4"},children:[{id:"card-1",type:"Card",state:{title:"Learning Guide"},attributes:{},children:[{id:"card-content",type:"Span",state:{text:"Card content with title header"},attributes:{className:"text-[var(--color-text-default)]"}}]}]}};return s.jsx(o,{document:e,components:i})},parameters:{docs:{description:{story:`
## Overview
...
- Feature groups
- Learning guides
        `}}}},a={render:()=>{const e={version:"1.0.0",root:{id:"root",type:"Div",attributes:{className:"p-4"},children:[{id:"card-sdui",type:"Card",state:{title:"SDUI Card Example"},attributes:{className:"w-full max-w-md"},children:[{id:"card-sdui-content",type:"Div",attributes:{className:"space-y-2"},children:[{id:"card-sdui-text-1",type:"Text",state:{text:"This card is rendered via SDUI Layout Document."}},{id:"card-sdui-text-2",type:"Text",state:{text:"The structure is defined in JSON format."}}]}]}]}};return s.jsx(o,{document:e,components:i})},parameters:{docs:{description:{story:`
## Overview
...
}`,...a.parameters?.docs?.source}}};const S=["Default","WithTitle","WithListItems","SduiIntegration"];export{t as Default,a as SduiIntegration,r as WithListItems,n as WithTitle,S as __namedExportsOrder,C as default};
