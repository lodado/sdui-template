import{j as o}from"./jsx-runtime-BuoH1CR4.js";import{r as c}from"./iframe-CLJzqSCR.js";import{S as u}from"./SduiDocumentEditor-CxZVnTrP.js";function l(e){return"blockId"in e?e.blockId:"block"in e?e.block.id:""}function d(e){const{type:n}=e,t=l(e);return t?`${n}  ${t}`:n}const r=({patches:e})=>e.length===0?o.jsx("pre",{className:"sdui-doc__log",children:"문서를 편집하면 여기에 패치가 순서대로 쌓입니다."}):o.jsx("pre",{className:"sdui-doc__log",children:e.slice(-14).map((n,t)=>`${String(e.length-Math.min(14,e.length)+t+1).padStart(2,"0")}  ${d(n)}`).join(`
