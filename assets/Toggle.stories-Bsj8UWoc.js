import{j as e}from"./jsx-runtime-Ba9ql8bq.js";import{r as u}from"./iframe-Crns1BDl.js";import{i as s,s as k}from"./sduiComponents-CYeIjoLY.js";import{S as f}from"./SduiLayoutRenderer-8Qc5a0CO.js";import"./preload-helper-ggYluGXI.js";import"./index-BWxGaPJe.js";import"./index-Y2FbehKm.js";import"./index-D5lcvBdA.js";import"./index-COIGb6gI.js";import"./schemas-BKIZ752n.js";const w={title:"Shared/UI/Toggle",component:s,tags:["autodocs"],argTypes:{size:{control:"select",options:["regular","large"],description:"Toggle size variant",table:{defaultValue:{summary:"regular"}}},isChecked:{control:"boolean",description:"Whether the toggle is checked (controlled)",table:{defaultValue:{summary:"false"}}},isDisabled:{control:"boolean",description:"Whether the toggle is disabled",table:{defaultValue:{summary:"false"}}},isLoading:{control:"boolean",description:"Whether the toggle is in loading state",table:{defaultValue:{summary:"false"}}},label:{control:"text",description:"Accessible label for the toggle"}},parameters:{docs:{description:{component:`
## Overview
