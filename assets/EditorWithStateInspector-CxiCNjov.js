import{j as n}from"./jsx-runtime-Dyb75U6t.js";import"./marked.esm-Ci4fhsQd.js";import{t as p}from"./toSduiLayout-ooNGaLo6.js";import{r as a}from"./iframe-dH36H_jw.js";import{S as E}from"./SduiLayoutStateInspector-tjrXyt--.js";import{S as T}from"./SduiDocumentEditor-D9q07rGx.js";function L(e){return"blockId"in e?e.blockId:"block"in e?e.block.id:""}function O(e){const{type:t}=e,o=L(e);return o?`${t}  ${o}`:t}const y=({patches:e})=>e.length===0?n.jsx("pre",{className:"sdui-doc__log",children:"문서를 편집하면 여기에 패치가 순서대로 쌓입니다."}):n.jsx("pre",{className:"sdui-doc__log",children:e.slice(-10).map((t,o)=>`${String(e.length-Math.min(10,e.length)+o+1).padStart(2,"0")}  ${O(t)}`).join(`
