...
}`,...G.parameters?.docs?.source},description:{story:"Interpolation Modes: 2D line chart with linear, cubic, and monotone cubic interpolation (canvas-3d 2D collection).",...G.parameters?.docs?.description}}};const Te=["StaticCube","RotatingCube","StaticHexagon","RotatingHexagon","StaticCup","RotatingCup","StaticCupFilled","RotatingCupFilled","InterpolationModes"];export{G as InterpolationModes,M as RotatingCube,Y as RotatingCup,B as RotatingCupFilled,O as RotatingHexagon,F as StaticCube,X as StaticCup,V as StaticCupFilled,H as StaticHexagon,Te as __namedExportsOrder,Se as default};
