import{j as n}from"./jsx-runtime-BDcnKkQN.js";import{e as E,s as r}from"./sduiComponents-DAozQnRg.js";import{S as d,u as L}from"./SduiLayoutRenderer-EIpWCah8.js";import{u as A}from"./useSduiNodeReference-BK6o6JhO.js";import"./iframe-DJ69XQwm.js";import"./preload-helper-ggYluGXI.js";import"./index-C3rzyWFX.js";import"./index-CnzO2P-b.js";import"./index-Cd2e6MZi.js";import"./index-CeLOyPbQ.js";import"./schemas-DwlGupW0.js";import"./useSduiLayoutAction-BBxdgFwF.js";const k=({id:e})=>{const{attributes:o}=L({nodeId:e}),{referencedNodes:t,hasReference:i}=A({nodeId:e}),p=o?.className,T=o?.options;if(!i||t.length===0)return n.jsx("span",{className:p,children:"No reference"});const l=t[0]?.state?.selectedId,c=T?.find(B=>B.id===l)?.label||l||"None";return n.jsx("span",{className:p,children:c})};k.displayName="ReferenceText";const j=({id:e})=>{const{attributes:o}=L({nodeId:e}),{referencedNodes:t,hasReference:i}=A({nodeId:e}),p=o?.className,T=o?.optionsMap;return i?n.jsx("div",{className:p,children:t.map((a,l)=>{const c=a?.state?.selectedId,M=T?.[a.id]?.find(V=>V.id===c)?.label||c||"None";return n.jsxs("div",{children:[n.jsxs("span",{className:"text-gray-500",children:[a.id,":"]})," ",n.jsx("span",{className:"font-medium",children:M})]},a.id||l)})}):n.jsx("div",{className:p,children:"No references configured"})};j.displayName="ReferenceDisplay";const s={...r,ReferenceText:e=>n.jsx(k,{id:e}),ReferenceDisplay:e=>n.jsx(j,{id:e})},Q={title:"Shared/UI/Dropdown",component:E.Root,tags:["autodocs"],parameters:{docs:{description:{component:`
## Overview
...
}`,...C.parameters?.docs?.source}}};const X=["AppearanceDefault","AppearancePrimary","AppearanceSubtle","AllAppearances","AllSpacings","Disabled","WithDisabledOptions","PlacementExamples","WithReferenceSdui","CascadingDropdownsSdui","MultipleReferencesSdui","CompoundPatternSdui","CompoundWithReferenceSdui","NestedDropdownsSdui","CustomTriggerSdui"];export{y as AllAppearances,b as AllSpacings,m as AppearanceDefault,u as AppearancePrimary,w as AppearanceSubtle,v as CascadingDropdownsSdui,x as CompoundPatternSdui,O as CompoundWithReferenceSdui,C as CustomTriggerSdui,g as Disabled,I as MultipleReferencesSdui,S as NestedDropdownsSdui,f as PlacementExamples,D as WithDisabledOptions,h as WithReferenceSdui,X as __namedExportsOrder,Q as default};
