import{j as t}from"./jsx-runtime-mA-n-d6H.js";import{r as c}from"./iframe-CBmONYCU.js";import{S as u,b as g}from"./SduiLayoutRenderer-Dnhr9FUr.js";import{s as m}from"./sduiComponents-Bh5wK3mF.js";import"./preload-helper-ggYluGXI.js";import"./index-CDV7cqJ4.js";import"./index-CynUYlTt.js";import"./index-dCEBnlvI.js";import"./index-DP-BN3tX.js";import"./index-CcR-zJDu.js";import"./Button-DwzDj1Tt.js";import"./schemas-BKIZ752n.js";const N={title:"Example/Reset to Initial",component:u,tags:["autodocs"],parameters:{docs:{description:{component:`
## Overview
...
- **After reset**: Document returns to initial state (3 toggles, all OFF)
        `}}}};function d(e){const o=Array.from({length:e},(i,n)=>({id:`toggle-${n+1}`,type:"Toggle",state:{isChecked:!1,label:`Toggle ${n+1}`}}));return{version:"1.0.0",root:{id:"root",type:"Div",state:{},children:[...o,{id:"reset-button-container",type:"Div",attributes:{className:"mt-4 flex justify-center"},children:[{id:"reset-button",type:"ResetButton"}]}]}}}const h=()=>{const e=g(),[o,i]=c.useState(null),n=()=>{try{e.resetToInitial(),i(null),console.log("Reset to initial document successful")}catch(r){const l=r instanceof Error?r.message:"Unknown error";i(l),console.error("Reset to initial failed:",l)}};return t.jsxs("div",{className:"flex flex-col gap-2",children:[t.jsx("button",{onClick:n,className:"px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 transition-colors",type:"button",children:"Reset to Initial"}),o&&t.jsxs("div",{className:"text-xs text-red-600 bg-red-50 p-2 rounded",children:["Error: ",o]})]})},a={render:()=>{const[e,o]=c.useState(3),[i,n]=c.useState(()=>d(3)),r=()=>{const s=e+1;o(s),n(d(s))},l=()=>{o(3),n(d(3))};return t.jsxs("div",{className:"flex flex-col gap-4 p-4",children:[t.jsxs("div",{className:"flex items-center gap-4",children:[t.jsxs("button",{onClick:r,className:"px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors",type:"button",children:["Add Toggle (",e," → ",e+1,")"]}),t.jsx("button",{onClick:l,className:"px-4 py-2 bg-gray-600 text-white rounded hover:bg-gray-700 transition-colors",type:"button",children:"Reset to 3 Toggles"}),t.jsxs("span",{className:"text-sm text-gray-600",children:["Current: ",e," toggles"]})]}),t.jsxs("div",{className:"border border-gray-300 rounded p-4 bg-gray-50",children:[t.jsx("div",{className:"mb-2 text-sm font-semibold text-gray-700",children:"Instructions:"}),t.jsxs("ol",{className:"list-decimal list-inside text-sm text-gray-600 space-y-1 mb-4",children:[t.jsx("li",{children:"Click each toggle to change its ON/OFF state"}),t.jsx("li",{children:'Click the "Add Toggle" button'}),t.jsx("li",{children:t.jsx("strong",{children:'Click "Reset to Initial" (rendered via SDUI) to restore the initial document state'})}),t.jsx("li",{children:"Verify that all toggles return to their initial state (3 toggles, all OFF)"})]}),t.jsx(u,{document:i,components:{...m,ResetButton:h},onLayoutChange:s=>{console.log("Document updated:",s)},onError:s=>{console.error("SDUI Error:",s)}})]}),t.jsxs("div",{className:"text-xs text-gray-500 p-2 bg-gray-100 rounded",children:[t.jsx("strong",{children:"Test Point:"}),' The "Reset to Initial" button uses \\`store.resetToInitial()\\` to restore the document to its initial state. This should reset all toggle states to their initial values (all OFF) and restore the document structure to 3 toggles, regardless of how many toggles were added or what states were changed.']})]})},parameters:{docs:{description:{story:`
...
}`,...a.parameters?.docs?.source},description:{story:`Reset to Initial Example
...
3. Click "Reset to Initial" to restore the initial document state`,...a.parameters?.docs?.description}}};const w=["ResetToInitialExample"];export{a as ResetToInitialExample,w as __namedExportsOrder,N as default};
