import{j as e}from"./jsx-runtime-mA-n-d6H.js";import{r as u}from"./iframe-CBmONYCU.js";import{h as s,s as k}from"./sduiComponents-Bh5wK3mF.js";import{S as f}from"./SduiLayoutRenderer-Dnhr9FUr.js";import"./preload-helper-ggYluGXI.js";import"./index-CDV7cqJ4.js";import"./index-CynUYlTt.js";import"./index-dCEBnlvI.js";import"./index-DP-BN3tX.js";import"./index-CcR-zJDu.js";import"./Button-DwzDj1Tt.js";import"./schemas-BKIZ752n.js";const I={title:"Shared/UI/Toggle",component:s,tags:["autodocs"],argTypes:{size:{control:"select",options:["regular","large"],description:"Toggle size variant",table:{defaultValue:{summary:"regular"}}},isChecked:{control:"boolean",description:"Whether the toggle is checked (controlled)",table:{defaultValue:{summary:"false"}}},isDisabled:{control:"boolean",description:"Whether the toggle is disabled",table:{defaultValue:{summary:"false"}}},isLoading:{control:"boolean",description:"Whether the toggle is in loading state",table:{defaultValue:{summary:"false"}}},label:{control:"text",description:"Accessible label for the toggle"}},parameters:{docs:{description:{component:`
## Overview
...
- **label**: Accessible label text
        `}}}},r={render:()=>e.jsxs("div",{className:"flex items-center gap-4 p-4",children:[e.jsx(s,{size:"regular",label:"Regular size"}),e.jsx("span",{className:"text-sm",children:"Regular (32x16px)"})]}),parameters:{docs:{description:{story:`
## Regular Size
...
- **Height**: 16px
- **Dot size**: 12px
        `}}}},i={render:()=>e.jsxs("div",{className:"flex items-center gap-4 p-4",children:[e.jsx(s,{size:"large",label:"Large size"}),e.jsx("span",{className:"text-sm",children:"Large (40x20px)"})]}),parameters:{docs:{description:{story:`
## Large Size
...
}`,...h.parameters?.docs?.source}}};const R=["Playground","SizeRegular","SizeLarge","StateChecked","StateUnchecked","StateDisabled","StateLoading","Controlled","Uncontrolled","SduiIntegration","SizeComparison","StatesMatrix"];export{g as Controlled,t as Playground,m as SduiIntegration,x as SizeComparison,i as SizeLarge,r as SizeRegular,l as StateChecked,o as StateDisabled,d as StateLoading,c as StateUnchecked,h as StatesMatrix,p as Uncontrolled,R as __namedExportsOrder,I as default};
