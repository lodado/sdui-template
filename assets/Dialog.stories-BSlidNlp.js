import{j as e}from"./jsx-runtime-BDcnKkQN.js";import{S as a,s as o,c as x,D as n}from"./sduiComponents-DAozQnRg.js";import{S as i}from"./SduiLayoutRenderer-EIpWCah8.js";import"./iframe-DJ69XQwm.js";import"./preload-helper-ggYluGXI.js";import"./index-C3rzyWFX.js";import"./index-CnzO2P-b.js";import"./index-Cd2e6MZi.js";import"./index-CeLOyPbQ.js";import"./schemas-DwlGupW0.js";import"./useSduiLayoutAction-BBxdgFwF.js";const P={title:"Features/UI/Dialog",component:a,tags:["autodocs"],argTypes:{size:{control:"select",options:["small","medium","large","xlarge"],description:"Dialog size",table:{defaultValue:{summary:"small"}}},hasCloseButton:{control:"boolean",description:"Whether to show close button",table:{defaultValue:{summary:"true"}}},title:{control:"text",description:"Dialog title"},description:{control:"text",description:"Dialog description (optional)"}},parameters:{docs:{description:{component:`
## Overview
...
}`,...D.parameters?.docs?.source}}};const j=["Playground","SizeSmall","SizeMedium","SizeLarge","SizeXLarge","AppearanceDefault","AppearanceDanger","AppearanceWarning","WithFormContent","ConfirmationPattern","CompoundPatternExample","AllSizes"];export{D as AllSizes,g as AppearanceDanger,p as AppearanceDefault,m as AppearanceWarning,h as CompoundPatternExample,y as ConfirmationPattern,r as Playground,d as SizeLarge,s as SizeMedium,l as SizeSmall,c as SizeXLarge,u as WithFormContent,j as __namedExportsOrder,P as default};
