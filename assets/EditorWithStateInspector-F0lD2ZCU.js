import{j as n}from"./jsx-runtime-DmsiW3bU.js";import"./marked.esm-DOvlcEBA.js";import{t as _}from"./toSduiLayout-BmARLnRe.js";import{r as a}from"./iframe-tZobWg1x.js";import{S as y}from"./SduiDocumentEditor-DZmr4H-i.js";import{S as g}from"./SduiLayoutStateInspector-qChz87uB.js";function E(e){return"blockId"in e?e.blockId:"block"in e?e.block.id:""}function L(e){const{type:t}=e,r=E(e);return r?`${t}  ${r}`:t}const T=({patches:e})=>e.length===0?n.jsx("pre",{className:"sdui-doc__log",children:"문서를 편집하면 여기에 패치가 순서대로 쌓입니다."}):n.jsx("pre",{className:"sdui-doc__log",children:e.slice(-10).map((t,r)=>`${String(e.length-Math.min(10,e.length)+r+1).padStart(2,"0")}  ${L(t)}`).join(`
