import{j as e}from"./jsx-runtime-CNHuL-bG.js";import{r as u}from"./iframe-Cb_hRcqQ.js";import{i as s,s as k}from"./sduiComponents-BL5hn7V4.js";import{S as f}from"./SduiLayoutRenderer-BMHgv4n-.js";import"./preload-helper-ggYluGXI.js";import"./index-DB4Skmac.js";import"./index-DffDiwav.js";import"./index-CAFVk6t3.js";import"./index-el-enIZk.js";import"./schemas-BKIZ752n.js";const w={title:"Shared/UI/Toggle",component:s,tags:["autodocs"],argTypes:{size:{control:"select",options:["regular","large"],description:"Toggle size variant",table:{defaultValue:{summary:"regular"}}},isChecked:{control:"boolean",description:"Whether the toggle is checked (controlled)",table:{defaultValue:{summary:"false"}}},isDisabled:{control:"boolean",description:"Whether the toggle is disabled",table:{defaultValue:{summary:"false"}}},isLoading:{control:"boolean",description:"Whether the toggle is in loading state",table:{defaultValue:{summary:"false"}}},label:{control:"text",description:"Accessible label for the toggle"}},parameters:{docs:{description:{component:`
## Overview
