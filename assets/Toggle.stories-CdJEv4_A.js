import{j as e}from"./jsx-runtime-PuOm43-g.js";import{r as u}from"./iframe-D3Woql-x.js";import{i as s,S as k,s as f}from"./sduiComponents-CQHVj3BB.js";import"./preload-helper-ggYluGXI.js";import"./index-Cj9u_gqh.js";import"./index-Dx-F_pgs.js";const j={title:"Shared/UI/Toggle",component:s,tags:["autodocs"],argTypes:{size:{control:"select",options:["regular","large"],description:"Toggle size variant",table:{defaultValue:{summary:"regular"}}},isChecked:{control:"boolean",description:"Whether the toggle is checked (controlled)",table:{defaultValue:{summary:"false"}}},isDisabled:{control:"boolean",description:"Whether the toggle is disabled",table:{defaultValue:{summary:"false"}}},isLoading:{control:"boolean",description:"Whether the toggle is in loading state",table:{defaultValue:{summary:"false"}}},label:{control:"text",description:"Accessible label for the toggle"}},parameters:{docs:{description:{component:`
## Overview
