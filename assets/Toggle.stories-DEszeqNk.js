import{j as e}from"./jsx-runtime-BP7xIkdw.js";import{r as u}from"./iframe-B-YFzlFs.js";import{i as s,s as k}from"./sduiComponents-AfZPlDts.js";import{S as f}from"./SduiLayoutRenderer-D4uP9wK8.js";import"./preload-helper-ggYluGXI.js";import"./index-BLadDp_R.js";import"./index-CE-KBjR2.js";import"./index-C0iLGTBD.js";import"./index-B9vkfQXZ.js";import"./schemas-BKIZ752n.js";const w={title:"Shared/UI/Toggle",component:s,tags:["autodocs"],argTypes:{size:{control:"select",options:["regular","large"],description:"Toggle size variant",table:{defaultValue:{summary:"regular"}}},isChecked:{control:"boolean",description:"Whether the toggle is checked (controlled)",table:{defaultValue:{summary:"false"}}},isDisabled:{control:"boolean",description:"Whether the toggle is disabled",table:{defaultValue:{summary:"false"}}},isLoading:{control:"boolean",description:"Whether the toggle is in loading state",table:{defaultValue:{summary:"false"}}},label:{control:"text",description:"Accessible label for the toggle"}},parameters:{docs:{description:{component:`
## Overview
