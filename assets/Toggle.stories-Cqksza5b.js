import{j as e}from"./jsx-runtime-DU7op2UO.js";import{r as u}from"./iframe-5X0zMWC6.js";import{i as s,s as k}from"./sduiComponents-DK1BAwFy.js";import{S as f}from"./SduiLayoutRenderer-CzHk1xK-.js";import"./preload-helper-ggYluGXI.js";import"./index-7r1S3uv8.js";import"./index-C00AqJfy.js";import"./index-BAuWC7FS.js";import"./schemas-nPDmCKRO.js";import"./useSduiLayoutAction-CNceG_KE.js";const w={title:"Shared/UI/Toggle",component:s,tags:["autodocs"],argTypes:{size:{control:"select",options:["regular","large"],description:"Toggle size variant",table:{defaultValue:{summary:"regular"}}},isChecked:{control:"boolean",description:"Whether the toggle is checked (controlled)",table:{defaultValue:{summary:"false"}}},isDisabled:{control:"boolean",description:"Whether the toggle is disabled",table:{defaultValue:{summary:"false"}}},isLoading:{control:"boolean",description:"Whether the toggle is in loading state",table:{defaultValue:{summary:"false"}}},label:{control:"text",description:"Accessible label for the toggle"}},parameters:{docs:{description:{component:`
## Overview
