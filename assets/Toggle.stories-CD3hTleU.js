import{j as e}from"./jsx-runtime-SONeQbs_.js";import{r as u}from"./iframe-wXaJxiyW.js";import{i as s,s as k}from"./sduiComponents-ia_xqjjz.js";import{S as f}from"./SduiLayoutRenderer-DP6F0gX6.js";import"./preload-helper-ggYluGXI.js";import"./index-DjHNRiIT.js";import"./index-DpWe-RS_.js";import"./index-xTQU9g3t.js";import"./schemas-nPDmCKRO.js";import"./useSduiLayoutAction-BB6kuH-P.js";const w={title:"Shared/UI/Toggle",component:s,tags:["autodocs"],argTypes:{size:{control:"select",options:["regular","large"],description:"Toggle size variant",table:{defaultValue:{summary:"regular"}}},isChecked:{control:"boolean",description:"Whether the toggle is checked (controlled)",table:{defaultValue:{summary:"false"}}},isDisabled:{control:"boolean",description:"Whether the toggle is disabled",table:{defaultValue:{summary:"false"}}},isLoading:{control:"boolean",description:"Whether the toggle is in loading state",table:{defaultValue:{summary:"false"}}},label:{control:"text",description:"Accessible label for the toggle"}},parameters:{docs:{description:{component:`
## Overview
