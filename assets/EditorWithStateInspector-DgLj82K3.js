import{j as n}from"./jsx-runtime-DLqdEGz0.js";import"./marked.esm-BwxuwTE_.js";import{t as g}from"./toSduiLayout-iPwLRabQ.js";import{r as a}from"./iframe-CLwkfY1b.js";import{S as y}from"./SduiDocumentEditor-oeZL5-_Q.js";import{S as _}from"./SduiLayoutStateInspector-Bg1cHvow.js";function k(e){return"blockId"in e?e.blockId:"block"in e?e.block.id:""}function f(e){const{type:t}=e,r=k(e);return r?`${t}  ${r}`:t}const E=({patches:e})=>e.length===0?n.jsx("pre",{className:"sdui-doc__log",children:"문서를 편집하면 여기에 패치가 순서대로 쌓입니다."}):n.jsx("pre",{className:"sdui-doc__log",children:e.slice(-10).map((t,r)=>`${String(e.length-Math.min(10,e.length)+r+1).padStart(2,"0")}  ${f(t)}`).join(`
`)}),L=({content:e})=>n.jsxs("section",{"aria-label":"SduiDocumentContent",style:{display:"grid",gap:8},children:[n.jsx("strong",{style:{fontSize:13},children:"Domain · SduiDocumentContent"}),n.jsx("pre",{style:{margin:0,padding:12,borderRadius:8,border:"1px solid #cbd5e1",background:"#fff7ed",color:"#0f172a",overflow:"auto",maxHeight:280,fontSize:12,lineHeight:1.45,whiteSpace:"pre-wrap",wordBreak:"break-word"},children:JSON.stringify(e,null,2)})]}),C=({content:e,readOnly:t,documentId:r="storybook-doc",title:o="Editor → SDUI layout state"})=>{const[i,s]=a.useState(e),[u,d]=a.useState([]),l=a.useMemo(()=>g(i,{documentId:r,title:o}),[i,r,o]);return n.jsxs("div",{style:{display:"grid",gap:16,gridTemplateColumns:"minmax(0, 1.1fr) minmax(0, 0.9fr)",alignItems:"start"},children:[n.jsxs("div",{style:{display:"grid",gap:12},children:[n.jsx(y,{content:e,readOnly:t,onContentChange:(m,c)=>{s(m),d(p=>[...p,...c])}}),!t&&n.jsx(E,{patches:u})]}),n.jsxs("div",{style:{display:"grid",gap:12},children:[n.jsx(L,{content:i}),n.jsx(_,{document:l,title:o,maxHeight:420})]})]})};C.__docgenInfo={description:`SduiDocumentEditor + live domain/layout JSON panels for Storybook debugging.
