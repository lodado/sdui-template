import{j as n}from"./jsx-runtime-M4qNp2Ke.js";import"./marked.esm-DuSADawC.js";import{t as _}from"./toSduiLayout-BxXGbDmW.js";import{r as a}from"./iframe-DA3Exl-z.js";import{S as y}from"./SduiDocumentEditor-DdGeXdlo.js";import{S as E}from"./SduiLayoutStateInspector-Iwos_iMJ.js";function g(e){return"blockId"in e?e.blockId:"block"in e?e.block.id:""}function L(e){const{type:t}=e,r=g(e);return r?`${t}  ${r}`:t}const T=({patches:e})=>e.length===0?n.jsx("pre",{className:"sdui-doc__log",children:"문서를 편집하면 여기에 패치가 순서대로 쌓입니다."}):n.jsx("pre",{className:"sdui-doc__log",children:e.slice(-10).map((t,r)=>`${String(e.length-Math.min(10,e.length)+r+1).padStart(2,"0")}  ${L(t)}`).join(`
