...
import { sduiComponents, Tooltip, TooltipProvider } from '@lodado/sdui-template-component'
...
export const CompoundPatternBasic: Story = {
  render: () => (
...
export const CompoundPatternWithArrow: Story = {
  render: () => (
    <div className="flex items-center justify-center p-20 gap-8">
      <Tooltip.Root>
        <Tooltip.Trigger>
...
export const CompoundPatternAlignments: Story = {
  render: () => (
    <div className="flex items-center justify-center p-20 gap-8">
      <Tooltip.Root>
        <Tooltip.Trigger>
  ...
  render: () => {
    const document: SduiLayoutDocument = {
      ...
      root: {
        id: 'root',
        type: 'Div',
        attributes: { className: 'flex items-center justify-center p-20' },
        children: [
          {
            id: 'tooltip-1',
            type: 'Tooltip',
            ...
            children: [
              {
                ...
                children: [{ id: 'text-1', type: 'Span', state: { text: 'Hover me' } }],
              },
            ],
          },
        ],
...
export const SduiSidePositions: Story = {
  render: () => {
    const document: SduiLayoutDocument = {
      version: '1.0.0',
      root: {
        ...
        children: [
          {
            id: 'title',
            type: 'Span',
            state: { text: 'SDUI Tooltip - Side Positions' },
            attributes: { className: 'text-xl font-bold' },
          },
          {
            id: 'tooltip-row',
            type: 'Div',
            attributes: { className: 'flex gap-8 items-center justify-center py-12' },
            children: [
              {
                id: 'tooltip-top',
                type: 'Tooltip',
                state: { content: 'Tooltip on top', side: 'top' },
                children: [
                  {
                    id: 'btn-top',
                    type: 'Button',
                    state: { appearance: 'default' },
                    children: [{ id: 'text-top', type: 'Span', state: { text: 'Top' } }],
                  },
                ],
              },
              {
                id: 'tooltip-right',
                type: 'Tooltip',
                state: { content: 'Tooltip on right', side: 'right' },
                children: [
                  {
                    id: 'btn-right',
                    type: 'Button',
                    state: { appearance: 'default' },
                    children: [{ id: 'text-right', type: 'Span', state: { text: 'Right' } }],
                  },
                ],
              },
              {
                id: 'tooltip-bottom',
                type: 'Tooltip',
                state: { content: 'Tooltip on bottom', side: 'bottom' },
                children: [
                  {
                    id: 'btn-bottom',
                    type: 'Button',
                    state: { appearance: 'default' },
                    children: [{ id: 'text-bottom', type: 'Span', state: { text: 'Bottom' } }],
                  },
                ],
              },
              {
                id: 'tooltip-left',
                type: 'Tooltip',
                state: { content: 'Tooltip on left', side: 'left' },
                children: [
                  {
                    id: 'btn-left',
                    type: 'Button',
                    state: { appearance: 'default' },
                    children: [{ id: 'text-left', type: 'Span', state: { text: 'Left' } }],
                  },
                ],
              },
            ],
...
export const SduiWithArrow: Story = {
  render: () => {
    const document: SduiLayoutDocument = {
      version: '1.0.0',
      root: {
        ...
        children: [
          {
            id: 'title',
            type: 'Span',
            state: { text: 'SDUI Tooltip - With Arrow' },
            attributes: { className: 'text-xl font-bold' },
          },
          {
            id: 'tooltip-row',
            ...
            children: [
              {
                ...
                type: 'Tooltip',
                state: { content: 'With arrow', side: 'top', showArrow: true },
                children: [
                  {
                    id: 'btn-arrow-top',
                    type: 'Button',
                    state: { appearance: 'primary' },
                    children: [{ id: 'text-arrow-top', type: 'Span', state: { text: 'Top Arrow' } }],
                  },
                ],
              },
              {
                ...
                type: 'Tooltip',
                state: { content: 'With arrow', side: 'right', showArrow: true },
                children: [
                  {
                    id: 'btn-arrow-right',
                    type: 'Button',
                    state: { appearance: 'primary' },
                    children: [{ id: 'text-arrow-right', type: 'Span', state: { text: 'Right Arrow' } }],
                  },
                ],
              },
              {
                ...
                type: 'Tooltip',
                state: { content: 'With arrow', side: 'bottom', showArrow: true },
                children: [
                  {
                    id: 'btn-arrow-bottom',
                    type: 'Button',
                    state: { appearance: 'primary' },
                    children: [{ id: 'text-arrow-bottom', type: 'Span', state: { text: 'Bottom Arrow' } }],
                  },
                ],
              },
              {
                ...
                type: 'Tooltip',
                state: { content: 'With arrow', side: 'left', showArrow: true },
                children: [
                  {
                    id: 'btn-arrow-left',
                    type: 'Button',
                    state: { appearance: 'primary' },
                    children: [{ id: 'text-arrow-left', type: 'Span', state: { text: 'Left Arrow' } }],
                  },
                ],
              },
            ],
...
export const SduiAlignments: Story = {
  render: () => {
    const document: SduiLayoutDocument = {
      version: '1.0.0',
      root: {
        ...
        children: [
          {
            id: 'title',
            type: 'Span',
            state: { text: 'SDUI Tooltip - Alignments' },
            attributes: { className: 'text-xl font-bold' },
          },
          {
            id: 'tooltip-row',
            ...
            children: [
              {
                id: 'tooltip-start',
                type: 'Tooltip',
                state: { content: 'Aligned to start', side: 'top', align: 'start', showArrow: true },
                children: [
                  {
                    id: 'btn-start',
                    type: 'Button',
                    state: { appearance: 'default' },
                    children: [{ id: 'text-start', type: 'Span', state: { text: 'Start Align' } }],
                  },
                ],
              },
              {
                id: 'tooltip-center',
                type: 'Tooltip',
                state: { content: 'Aligned to center', side: 'top', align: 'center', showArrow: true },
                children: [
                  {
                    id: 'btn-center',
                    type: 'Button',
                    state: { appearance: 'default' },
                    children: [{ id: 'text-center', type: 'Span', state: { text: 'Center Align' } }],
                  },
                ],
              },
              {
                id: 'tooltip-end',
                type: 'Tooltip',
                state: { content: 'Aligned to end', side: 'top', align: 'end', showArrow: true },
                children: [
                  {
                    id: 'btn-end',
                    type: 'Button',
                    state: { appearance: 'default' },
                    children: [{ id: 'text-end', type: 'Span', state: { text: 'End Align' } }],
                  },
                ],
              },
            ],
...
export const SduiButtonAppearances: Story = {
  render: () => {
        ...
        children: [
          {
            id: 'title',
            type: 'Span',
            state: { text: 'SDUI Tooltip - With Button Appearances' },
            attributes: { className: 'text-xl font-bold' },
          },
          {
            id: 'tooltip-row',
            type: 'Div',
            attributes: { className: 'flex flex-wrap gap-4 items-center justify-center py-8' },
...
export const SduiCompleteMatrix: Story = {
  render: () => {
        ...
        children: [
          {
            id: 'title',
            type: 'Span',
            state: { text: 'SDUI Tooltip - Complete Matrix (12 Combinations)' },
            attributes: { className: 'text-2xl font-bold' },
          },
          {
            id: 'subtitle',
            type: 'Span',
            state: { text: '4 Sides × 3 Alignments = 12 Positions' },
            ...
            children: [
              {
                ...
                type: 'Span',
                state: { text: `Side: ${side.charAt(0).toUpperCase() + side.slice(1)}` },
                attributes: { className: 'text-lg font-semibold' },
              },
              {
                id: `buttons-${side}`,
                type: 'Div',
                attributes: { className: 'flex gap-4 items-center justify-center py-8' },
                      ...
                      children: [
                        {
                          id: `text-${side}-${align}`,
                          type: 'Span',
                          state: { text: align.charAt(0).toUpperCase() + align.slice(1) },
                        },
                      ],
                    },
                  ],
...
export const SduiRealWorldExample: Story = {
  render: () => {
    const document: SduiLayoutDocument = {
      version: '1.0.0',
      root: {
        ...
        children: [
          {
            id: 'title',
            type: 'Span',
            state: { text: 'SDUI Tooltip - Real World Example' },
            attributes: { className: 'text-xl font-bold' },
          },
          {
            id: 'card',
            type: 'Card',
            attributes: { className: 'p-6 max-w-md' },
            children: [
              {
                id: 'card-header',
                type: 'Div',
                attributes: { className: 'flex items-center justify-between mb-4' },
                children: [
                  {
                    id: 'card-title',
                    type: 'Span',
                    state: { text: 'Project Actions' },
                    attributes: { className: 'text-lg font-semibold' },
                  },
                  {
                    id: 'tooltip-info',
                    type: 'Tooltip',
                    state: { content: 'Click actions to manage your project', side: 'left' },
                    children: [
                      {
                        id: 'info-button',
                        type: 'Button',
                        state: { appearance: 'subtle', spacing: 'compact' },
                        children: [{ id: 'info-text', type: 'Span', state: { text: '?' } }],
                      },
                    ],
                  },
                ],
              },
              {
                id: 'actions-row',
                type: 'Div',
                attributes: { className: 'flex gap-2' },
                children: [
                  {
                    id: 'tooltip-add',
                    type: 'Tooltip',
                    state: { content: 'Add new item', side: 'bottom', showArrow: true },
                    children: [
                      {
                        id: 'add-button',
                        type: 'Button',
                        state: { appearance: 'primary' },
                        children: [{ id: 'add-text', type: 'Span', state: { text: '+' } }],
                      },
                    ],
                  },
                  {
                    id: 'tooltip-edit',
                    type: 'Tooltip',
                    state: { content: 'Edit selected', side: 'bottom', showArrow: true },
                    children: [
                      {
                        id: 'edit-button',
                        type: 'Button',
                        state: { appearance: 'default' },
                        children: [{ id: 'edit-text', type: 'Span', state: { text: 'Edit' } }],
                      },
                    ],
                  },
                  {
                    id: 'tooltip-save',
                    type: 'Tooltip',
                    state: { content: 'Save changes', side: 'bottom', showArrow: true },
                    children: [
                      {
                        id: 'save-button',
                        type: 'Button',
                        state: { appearance: 'primary' },
                        children: [{ id: 'save-text', type: 'Span', state: { text: 'Save' } }],
                      },
                    ],
                  },
                  {
                    id: 'tooltip-delete',
                    type: 'Tooltip',
                    state: { content: 'Delete item (cannot be undone)', side: 'bottom', showArrow: true },
                    children: [
                      {
                        id: 'delete-button',
                        type: 'Button',
                        state: { appearance: 'danger' },
                        children: [{ id: 'delete-text', type: 'Span', state: { text: 'Delete' } }],
                      },
                    ],
                  },
                ],
...
// ============================================================================
// Controlled Mode (SDUI)
// ============================================================================

export const SduiControlledMode: Story = {
  render: () => {
