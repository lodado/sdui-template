...
describe('Button - Logic Tests', () => {
  ...
  describe('as is: Button with disabled state', () => {
    describe('when: disabled prop is true', () => {
      it('to be: disabled styles applied, onClick not called', async () => {
        ...
        render(
          <Button buttonStyle="filled" buttonType="primary" disabled onClick={handleClick}>
            Disabled
          </Button>,
        )
  ...
  describe('as is: Button with nodeId, SDUI document loaded', () => {
    describe('when: node state changes', () => {
      it('to be: button reflects state changes', () => {
        ...
        rerender(
          <Button nodeId="button-1" disabled>
            SDUI Button
          </Button>,
        )
