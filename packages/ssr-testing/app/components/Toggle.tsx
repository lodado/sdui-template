...
const ToggleComponent: React.FC<ToggleProps> = ({ id }) => {
  ...
  return (
    <div className="flex items-center gap-2 p-3 bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800 h-full" data-testid={`toggle-container-${id}`}>
      {label && (
        <label 
