// STAGED CONTRACT — no adapter implements this yet. Port for the planned
// document search-indexing feature; kept ahead of its adapter so the shape is
// pinned. Delete if search indexing is dropped from the roadmap.
